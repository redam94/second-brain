...
|-------|-------|-------------|
| [[Bayesian Statistics/_Index\|Bayesian Statistics]] | 201 | Bayes' theorem, conjugate priors, hierarchical models, MCMC/HMC, GLMs, GPs, spatial, copulas, BART, Bayesian IPW, Bayesian causal inference, **simulation-based calibration (SBC)**, and the full **2026 *Bayesian Workflow* textbook** (79 notes: model building and priors, predictive checking, PSIS-LOO, computational failure modes, 16 case studies) |
