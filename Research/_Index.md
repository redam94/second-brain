...
| [[Causal Discovery/_Index\|Causal Discovery]] | 10 | DAG / Bayesian-network structure learning, **PC algorithm** (constraint-based, CI tests, CPDAG), **GES** (score-based, equivalence-class search, Meek Conjecture), **Markov equivalence / CPDAGs**, **NOTEARS** continuous optimization, smooth acyclicity $h(W)=\mathrm{tr}\,e^{W\circ W}-d$, three-paradigm comparison |
