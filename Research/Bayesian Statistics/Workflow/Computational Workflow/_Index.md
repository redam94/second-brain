...
## See Also
- [[Simulation-Based Calibration/_Index|Simulation-Based Calibration]] — validating that the computation is correct, not just converged
- [[Evaluating and Comparing/_Index|Evaluating and Comparing]] — checking the model rather than the computation
