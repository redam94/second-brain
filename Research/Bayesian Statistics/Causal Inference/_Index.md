...
> - For **optimal dynamic treatment regimes** (sequential decisions, Q-learning, A-learning)? → [[Dynamic Treatment Regimes/_Index|Dynamic Treatment Regimes]]
...
| [[Dynamic Treatment Regimes/_Index\|Dynamic Treatment Regimes]] | 5 | Optimal multi-stage treatment rules; potential-outcomes framework; backward induction (Q/value functions); Q-learning; A-learning, g-estimation & double robustness (Schulte, Tsiatis, Laber & Davidian 2014) |
