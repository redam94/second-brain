...
- [[Bayesian Inverse Probability Weighting]] — Bayesian IPW via Liao-Zigler two-stage method (Heiss blog)
- [[Bayesian Propensity Score Weighting]] — Bayesian propensity score weighting — related to [[Propensity Score in Bayesian CI]] Strategy 3
