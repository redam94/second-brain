...
- The NP-hardness motivates CaGReS as a practical solution — analogous to how MCMC methods address intractable posteriors in [[MCMC Basics|Bayesian inference]].
