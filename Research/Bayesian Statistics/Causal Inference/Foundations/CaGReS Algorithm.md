...
- The semantic constraint makes CaGReS appropriate for high-dimensional data where domain knowledge is available — analogous to informative priors in [[General Structure of Bayesian CI|Bayesian causal inference]].
