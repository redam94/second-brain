...
> This folder covers the Bayesian approach to causal inference: the likelihood factorization, prior independence assumption, outcome model specification, and the role of the propensity score. Contains 4 notes.
...
> - Need the Liao-Zigler two-stage Bayesian IPW implementation (brms/Stan)? → [[Bayesian Propensity Scores and IPW]]
...
- [[Bayesian Propensity Scores and IPW]] — CONTAINS: Liao-Zigler two-stage method, Heiss brms/Stan implementation, propagating design-stage uncertainty into outcome model
