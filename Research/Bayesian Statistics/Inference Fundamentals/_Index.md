...
> - Need empirical Bayes, the James-Stein estimator, or shrinkage/risk-dominance theory? -> [[Empirical Bayes/_Index|Empirical Bayes]]
...
|-----------|-------|--------|
| [[Empirical Bayes/_Index\|Empirical Bayes]] | 5 | Robbins' formula, the James-Stein estimator, Stein's paradox / risk dominance, parametric EB and the empirical-Bayes view of shrinkage — Efron, *Large-Scale Inference* Ch. 1 |
