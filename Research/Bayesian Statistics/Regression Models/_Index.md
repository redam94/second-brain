...
> [!abstract] Summary
> BDA3 Part IV (Chapters 14-18): Bayesian approaches to regression — linear, hierarchical/multilevel, generalized linear models, and missing data handling via multiple imputation.
