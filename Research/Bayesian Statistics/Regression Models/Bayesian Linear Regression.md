...
- **Horseshoe prior** (global-local shrinkage): heavy-tailed, allows large signals while shrinking noise — state of the art for sparse problems
...
- Horseshoe and Regularized Horseshoe Priors — gap note pending (Dream #20); global-local shrinkage for high-dimensional sparse regression
