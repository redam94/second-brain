...
- [[Word of Mouth Mechanisms]] — CONTAINS: WOM utility component ($U_{i3}$), WOM generation rules, positive/negative WOM, WOM in CUBES (imitation process), WOM in Bonabeau (local adoption fraction), empirical claims
...
- [[../Market Dynamics/_Index|Market Dynamics]] — the outcomes WOM produces
