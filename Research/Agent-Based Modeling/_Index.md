...
> - For **LLM-powered agents** (generative agents, silicon samples / simulated respondents, homo silicus, validity and calibration of LLM populations) -> [[LLM-Powered Agents/_Index|LLM-Powered Agents]]
