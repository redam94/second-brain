...
> - For global (variance-based) sensitivity analysis — Sobol, Morris, FAST -> [[Agent-Based Modeling/Calibration and Validation/Sensitivity Analysis/_Index|Sensitivity Analysis]]
...
- [[Sensitivity Analysis/_Index|Sensitivity Analysis]] — COVERS: global (variance-based) sensitivity analysis — Sobol first-order & total-effect indices, the ANOVA/HDMR decomposition, Morris elementary-effects screening ($\mu^*,\sigma$), Saltelli sampling & FAST, local-vs-global pitfalls, SALib (5 notes; GSA review 2024)
