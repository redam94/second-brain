...
- [[GES - Greedy Equivalence Search]] — FGS is the fast implementation of GES (Chickering 2002)
- [[PC Algorithm]] — PC algorithm details (also a baseline in the supplement)
