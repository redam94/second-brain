...
> - Need the PC algorithm, FCI, GES, or LiNGAM/ANM (constraint- & score-based discovery)? → [[Causal Discovery/Constraint and Score-Based Discovery/_Index|Constraint and Score-Based Discovery]]

## Sub-topics

| Sub-topic | Notes | Covers |
|-----------|-------|--------|
| [[Causal Discovery/Constraint and Score-Based Discovery/_Index\|Constraint and Score-Based Discovery]] | 5 | Markov & faithfulness assumptions / CPDAG, the PC algorithm & FCI (constraint-based), GES (score-based), functional causal models (LiNGAM, ANM) — Glymour, Zhang & Spirtes (2019) |
