...
| **Local / approximate search** ([[GES - Greedy Equivalence Search\|GES/FGS]], hill-climbing, MMHC) | Add edges/parents one node at a time, check acyclicity incrementally | Needs bounded in-degree/treewidth — impossible to verify; real networks are scale-free with hub nodes |
...
| **Constraint-based** ([[PC Algorithm\|PC]], [Spirtes & Glymour, 1991]) | Conditional-independence tests | Different paradigm; often less accurate. See [[Constraint-Based Structure Learning]]. |
...
- [[Markov Equivalence and CPDAGs]] — what structure learning can identify from observational data
- [[GES - Greedy Equivalence Search]] — score-based MEC search (the "FGS" baseline in NOTEARS experiments)
- [[PC Algorithm]] — constraint-based alternative using CI tests
