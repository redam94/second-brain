...
## See Also
- [[Integration/_Index|Integration]] — Bayesian quadrature and integration as inference.
- [[Linear Algebra/_Index|Linear Algebra]] — probabilistic linear solvers and conjugate gradients.
- [[Optimisation/_Index|Optimisation]] — local/global optimisation, Bayesian optimisation.
- [[Differential Equations/_Index|Differential Equations]] — ODE filters, solvers as inference.
