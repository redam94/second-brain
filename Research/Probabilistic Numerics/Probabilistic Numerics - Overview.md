...
> - Solving linear systems as inference → [[Linear Algebra/_Index|Linear Algebra]]
> - Local & global optimisation, Bayesian optimisation → [[Optimisation/_Index|Optimisation]]
...
| II. Integration | [[Integration/_Index\|Integration]] | $\int f\,\mathrm{d}\nu$ | Trapezoid, Gauss & Clenshaw–Curtis quadrature → [[Classical Quadrature as Inference]] |
| III. Linear Algebra | [[Linear Algebra/_Index\|Linear Algebra]] | solve $Ax=b$ | Conjugate Gradients, Cholesky → [[Conjugate Gradients as Probabilistic Inference]] |
| IV–V. Optimisation | [[Optimisation/_Index\|Optimisation]] | $\min_x f(x)$ | Line search, BFGS, Bayesian optimisation → [[First- and Second-Order Optimisation Methods]], [[Bayesian Optimisation]] |
| VI. Differential Equations | [[Differential Equations/_Index\|Differential Equations]] | solve $\dot y = f(y,t)$ | Runge–Kutta, multistep → [[Classical ODE Solvers as Regression]], [[ODE Filters and Smoothers]] |
