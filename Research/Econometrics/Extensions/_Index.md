...
> This folder covers extensions to the core econometric toolkit: three standalone method notes (MHE Ch. 7–8 + PyMC) plus two sub-topics on simulation-based estimation. Contains 23 notes across 3 areas.
