...
- [[Propensity Score Matching - Overview]] — the theoretical framework for which these diagnostics are the empirical check
...
- [[Bayesian Propensity Score Weighting]] — the Bayesian IPW approach, which uses ESS and weight distributions as analogous diagnostics
