...
> - Need vine copulas, pair-copula constructions, C-vine, D-vine, or h-functions? -> [[Dependence Modeling/_Index|Dependence Modeling]]
> - Need to choose between factor copula and vine copula architectures? -> [[Dependence Modeling/Copula Architecture Comparison|Copula Architecture Comparison]]
...
| [[Dependence Modeling/_Index\|Dependence Modeling]] | 10 | High-dimensional copulas: **factor copulas** (construction, tail dependence via EVT, block structures, SMM, S&P 100) and **vine/pair-copula constructions** (Bedford-Cooke vine, C-vine, D-vine, h-function, sequential MLE, structure selection, architecture comparison) |
...
- [[raw/Aas-Czado-2009-Vine-Copula-Survey.md]] — Survey synthesis: Aas, Czado, Frigessi & Bakken (2009) Insurance: Mathematics and Economics 44:182-198; Bedford & Cooke (2002) Annals of Statistics 30:1031-1068; Dissmann et al. (2013) Computational Statistics & Data Analysis 59:52-69 — vine copulas, pair-copula constructions, C-vine, D-vine, h-function, sequential MLE, structure selection
