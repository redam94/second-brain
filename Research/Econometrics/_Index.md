...
> - Need high-dimensional dependence / copulas, tail dependence, factor copulas, **or vine/pair copulas**? -> [[Dependence Modeling/_Index|Dependence Modeling]]
...
| [[Dependence Modeling/_Index\|Dependence Modeling]] | 10 | High-dimensional copulas, **factor copulas** (latent-variable, SMM, scalable to N=100+) and **vine/pair copulas** (PCC, C-vine/D-vine, sequential MLE, heterogeneous pair-wise tail dependence), architecture comparison |
