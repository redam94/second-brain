...
| [[Dependence Modeling/_Index\|Dependence Modeling]] | 10 | High-dimensional copulas: factor-copula construction, tail dependence via EVT, multi-factor/block structures, rank-based SMM, S&P 100 & systemic risk (Oh & Patton 2012); **vine/pair copulas** (Aas et al. 2009): C-vine, D-vine, R-vine, pair copula families, sequential MLE, architecture comparison |
...
- [[raw/Vine-Copulas-Aas2009-Bedford2002-Czado2019-Synthesis.md]] — Survey synthesis: Aas et al. (2009) Insur. Math. Econ. 44(2):182–198, Bedford & Cooke (2002) Ann. Statist. 30(4):1031–1068, Czado (2019) Springer LNS — vine copula PCC, C-vine/D-vine/R-vine structures, h-function, bivariate copula families, sequential MLE, simplifying assumption, architecture comparison
