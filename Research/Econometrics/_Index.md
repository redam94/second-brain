...
| [[Dependence Modeling/_Index\|Dependence Modeling]] | 9 | High-dimensional copulas, factor-copula construction, tail dependence via EVT, multi-factor/block structures, rank-based SMM, S&P 100 & systemic risk (Oh & Patton 2012); **vine/pair copulas**: C-vine, D-vine, h-functions, sequential estimation, architecture comparison (Aas et al. 2009) |
...
- [[raw/Vine-Copula-Aas-Czado-Survey.md]] — Synthesis survey: Aas et al. (2009), Bedford & Cooke (2001/2002), Joe (1996) — vine/pair copula construction, C/D-vine structures, h-functions, sequential estimation (source PDFs paywalled; training knowledge synthesis)
