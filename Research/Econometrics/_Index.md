...
> This folder covers applied econometrics and causal inference from Mostly Harmless Econometrics plus Bayesian DiD, synthetic control, DAG tutorials, Bayesian propensity weighting, **classical propensity score matching (PSM)**, simulation-based estimation, staggered difference-in-differences, and high-dimensional dependence (copula) modelling — now including **vine/pair copula constructions** (C-vine, D-vine, R-vine, Dissmann structure selection) complementing the factor-copula cluster. Contains 56 notes across 6 sub-topics.
...
| [[Dependence Modeling/_Index\|Dependence Modeling]] | 11 | High-dimensional copulas: factor copulas (Oh & Patton 2012 — latent factor, SMM, EVT tail dep, S&P 100) + **vine/pair copulas** (Aas et al. 2009; Dissmann et al. 2013 — C/D/R-vine, h-functions, sequential MLE, structure selection) + copula architecture comparison |
...
- [[Dependence Modeling/raw/Vine-Copula-Synthesis-Survey.md]] — Synthesis survey: Aas et al. (2009) IME, Dissmann et al. (2013) CSDA, Czado & Nagler (2022) AnnRevStat, Bedford & Cooke (2002) AnnStat — vine/pair copula constructions, h-functions, R-vine structure selection, copula architecture comparison
