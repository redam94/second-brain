...
- [[Copula Estimation|Bayesian Copula Estimation]] — Bayesian Gaussian copula via PyMC; the simpler bivariate alternative to the high-dimensional factor copula approach here
