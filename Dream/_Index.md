...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[Constraint-Based Structure Learning]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-07-23)
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence and CPDAGs]], [[Constraint-Based Structure Learning]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-07-23 |
...
| 2026-07-23 | Gap #9 (Causal Structure Learning from Data — PC algorithm + GES) marked 🍂 covered. PDF downloads blocked (jmlr.org, arxiv.org both returned 403 from session network policy). Created synthesis survey `raw/PC-GES-Causal-Discovery-Survey.md` from training knowledge of: Spirtes, Glymour & Scheines (2000); Verma & Pearl (1990) UAI; Meek (1995) UAI; Chickering (2002) JMLR; Kalisch & Bühlmann (2007) JMLR; Colombo & Maathuis (2014) JMLR. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, Meek rules R1–R4, 3-node worked example, interventional/non-Gaussian limits of observational identification), [[Constraint-Based Structure Learning]] (Markov condition, faithfulness, Fisher z-test + discrete + kernel CI tests, 3-phase template, PC-stable motivation, high-dim consistency), [[PC Algorithm]] (skeleton pseudocode, v-structure detection, PC-stable, full worked example, Kalisch-Bühlmann consistency theorem), [[GES - Greedy Equivalence Search]] (decomposable scores, INSERT/DELETE operators, FES/BES algorithms, Chickering Thm. 15, FGES, PC-vs-GES comparison table, worked example). Updated Causal Discovery `_Index.md` (5→9 notes). Cross-linked NOTEARS cluster (DAG Structure Learning Problem landscape table + See Also, NOTEARS Overview See Also, NOTEARS Experiments See Also) to new notes. |
