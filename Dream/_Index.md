...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[Conditional Independence Testing in Causal Discovery]], [[GES - Greedy Equivalence Search]], [[Causal Discovery Algorithm Comparison]] (all in `Causal Discovery/`, created 2026-08-28)
...
| Causal Structure Learning / PC + GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[Conditional Independence Testing in Causal Discovery]], [[GES - Greedy Equivalence Search]], [[Causal Discovery Algorithm Comparison]] | 2026-08-28 |
...
| 2026-08-28 | Gap #9 (Causal Structure Learning — PC algorithm and GES) marked 🍂 covered. Searched for freely available PDFs: arXiv and JMLR blocked by session network policy. Downloaded two freely available GitHub-hosted PDFs: Lee et al. UAI 2025 (`lee25a-constraint-causal-discovery.pdf`, C-PC algorithm; background on constraint-based paradigm) and Chan et al. PMLR 2024 (`chan24a-autocd.pdf`, AutoCD; algorithm landscape overview). Created 5 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Verma–Pearl theorem, v-structures, CPDAG definition, Meek's rules), [[PC Algorithm - Overview]] (3 phases: skeleton/v-structure/Meek, assumptions, complexity, PC-stable, examples), [[Conditional Independence Testing in Causal Discovery]] (Fisher's Z, G², KCI/RCIT; multiple testing; finite-sample power), [[GES - Greedy Equivalence Search]] (FES/BES phases, BIC/BDe scores, Meek Conjecture, consistency theorem), [[Causal Discovery Algorithm Comparison]] (PC vs GES vs NOTEARS head-to-head table, hybrid methods, when-to-use guide). Updated `Causal Discovery/_Index.md` (5→10 notes). Primary sources for Chickering (2002) and Spirtes et al. (2000) synthesized from training knowledge (direct downloads blocked). |
