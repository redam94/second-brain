...
**Covered by:** [[Constraint-Based Causal Discovery]], [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]] (all in `Causal Discovery/`, created 2026-07-14)
...
| Causal Structure Learning — PC & GES (#9) | [[Constraint-Based Causal Discovery]], [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]] | 2026-07-14 |
...
| 2026-07-14 | Gap #9 (Causal Structure Learning — PC & GES) marked 🍂 covered. Direct PDF downloads of Chickering (2002 JMLR) and Kalisch & Bühlmann (2007 JMLR/arXiv) blocked by session proxy. Created synthesis survey `raw/PC-GES-Causal-Structure-Learning-Survey.md` from training knowledge of: Spirtes & Glymour (1991), Spirtes, Glymour & Scheines (2000), Verma & Pearl (1990), Meek (1995), Chickering (2002), Kalisch & Bühlmann (2007), Ramsey et al. (2017 FGES). Created 4 notes in `Causal Discovery/`: [[Constraint-Based Causal Discovery]] (d-sep, CMC, faithfulness, CI tests, FCI), [[Markov Equivalence and CPDAGs]] (Verma–Pearl theorem, CPDAG, covered edge reversals, Meek Conjecture), [[PC Algorithm]] (3-phase pseudocode, v-structure soundness, Meek R1–R4, Kalisch–Bühlmann consistency, stable PC, complexity/software tables), [[Greedy Equivalence Search (GES)]] (BIC score, Insert/Delete operators, FES+BES pseudocode, Chickering Th.15 consistency, FGES, PC vs GES table). Updated Causal Discovery _Index.md (5→9 notes). Cross-linked new notes into [[DAG Structure Learning Problem]], [[NOTEARS Experiments]], [[NOTEARS - Overview]]. |
