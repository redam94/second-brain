...
**Covered by:** [[Vine Copulas - Overview]], [[Regular Vine Structure]], [[C-Vine and D-Vine]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-10)
...
| Factor & Vine Copulas / Architecture Comparison (#8) | [[Vine Copulas - Overview]], [[Regular Vine Structure]], [[C-Vine and D-Vine]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] | 2026-09-10 |
...
| 2026-09-10 | Ingest run (gap #8): vine copulas and copula architecture comparison. Gap #8 marked 🍂 covered. Direct PDF download of Aas et al. (2009), Bedford & Cooke (2001/2002), Czado & Nagler (2022) blocked by network proxy; created `raw/Vine-Copulas-Source-Extract.md` from training knowledge of these papers. Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (pair-copula construction, simplifying assumption, vine type comparison table), [[Regular Vine Structure]] (Bedford & Cooke 2002 R-vine definition, proximity condition, constraint set, parameter count), [[C-Vine and D-Vine]] (D-vine density Eq. 3, C-vine density Eq. 4, h-function table, recursion theorem), [[Vine Copula Estimation and Selection]] (sequential ML, full ML, Dissmann MST algorithm, AIC/BIC family selection, truncation), [[Copula Architecture Comparison]] (full 5-architecture table, scalability, tail-dependence mechanism, decision guide). Updated `Econometrics/Dependence Modeling/_Index.md` (6→11 notes). |
