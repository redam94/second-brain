...
**Covered by:** [[Causal Structure Learning - Methods Overview]], [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[Conditional Independence Testing for Causal Discovery]], [[GES Algorithm]] (all in `Research/Causal Discovery/`, created 2026-09-21)
...
| Causal Structure Learning — PC / GES (#9) | [[Causal Structure Learning - Methods Overview]], [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[Conditional Independence Testing for Causal Discovery]], [[GES Algorithm]] | 2026-09-21 |
...
| 2026-09-21 | Dream gap ingest: Gap #9 (Causal Structure Learning — PC / GES). Searched jmlr.org and arxiv.org for Chickering (2002) and Kalisch & Bühlmann (2007) — both blocked by network egress policy. Created citation stubs `raw/chickering02b-GES-citation.md` and `raw/kalisch07a-PC-citation.md`. Created 5 notes in `Research/Causal Discovery/`: [[Causal Structure Learning - Methods Overview]] (three-family survey + comparison table), [[Markov Equivalence Classes and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, identifiability table), [[PC Algorithm]] (three phases + correctness + Kalisch 2007 high-dim result + Meek's 4 rules), [[Conditional Independence Testing for Causal Discovery]] (Fisher Z, chi-squared, HSIC, PC-stable), [[GES Algorithm]] (Meek conjecture proof, Insert/Delete operators, FES/BES phases, BIC/BDeu). Updated `Causal Discovery/_Index.md` (5 → 10 notes). Gap #9 marked 🍂 covered. |
