...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-vine and D-vine Structures]], [[Vine Copula Estimation and Model Selection]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-20)
...
| Factor Copulas and High-Dimensional Copula Architectures (#8) — vine/PCC portion | [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-vine and D-vine Structures]], [[Vine Copula Estimation and Model Selection]] | 2026-08-20 |
...
| 2026-08-20 | Gap #8 (vine/pair-copula portion) marked 🍂 covered. Attempted PDF downloads of Aas et al. (2009) and Bedford & Cooke (2002) from LMU Munich repository, INRIA, and arXiv — all blocked by session network egress policy. Created synthesis source stub `raw/Aas-Czado-Frigessi-Bakken-2009-Vine-Copulas.md` (following PSM precedent) covering both papers from training knowledge. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (curse of dimensionality, historical development Joe 1996 → Bedford & Cooke → Aas et al. 2009, copula landscape comparison), [[Pair-Copula Construction]] (vine density factorisation theorem, n=3/n=4 D-vine worked examples, h-function definition and closed-form expressions for Gaussian/t/Clayton/Gumbel, simplifying assumption), [[C-vine and D-vine Structures]] (regular vine definition with proximity condition, C-vine star-trees, D-vine path-graphs, R-vine MST algorithm, 4-variable examples for both, comparison table), [[Vine Copula Estimation and Model Selection]] (three-stage pipeline: marginals→structure→pair copulas; MST algorithm, sequential vs full MLE, AIC family selection, truncation, VineCopula/vinecopulib/pyvinecopulib software, 5-variable worked example). Updated Dependence Modeling _Index.md (6→10 notes). |
