...
**Covered by:** [[Causal Structure Learning - Overview]], [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-07-28)
...
| Causal Structure Learning (#9) | [[Causal Structure Learning - Overview]], [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-07-28 |
...
| 2026-07-28 | Run 17: Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Downloads of Chickering (2002) JMLR and Kalisch & Bühlmann (2007) arXiv blocked by session network policy (arxiv.org and jmlr.org return 403 from egress proxy). Created synthesis survey `raw/PC-GES-Causal-Structure-Learning-Survey.md` from training knowledge of: Chickering (2002) GES / Meek Conjecture; Kalisch & Bühlmann (2007) high-dimensional PC; Colombo & Maathuis (2014) PC-stable; Spirtes, Glymour & Scheines (2000) PC algorithm; Verma & Pearl (1990) Markov equivalence characterisation; Meek (1995) orientation rules. Created 4 notes in `Causal Discovery/`: [[Causal Structure Learning - Overview]] (paradigm map, three families, CPDAG theory, complexity tradeoffs, software), [[Markov Equivalence and CPDAGs]] (Markov condition, faithfulness, Verma-Pearl theorem, v-structures, CPDAG definition, Meek R1–R4 orientation rules, worked examples), [[PC Algorithm]] (3-phase pseudocode, Fisher Z-test and G² CI tests, PC consistency theorem, PC-stable order-independence fix, high-dimensional KB 2007 theorem, failure modes, worked 3-variable example), [[GES - Greedy Equivalence Search]] (decomposable score, Insert/Delete CPDAG operators, GES pseudocode, Meek Conjecture proof summary, GES consistency theorem, PC vs GES comparison table, software). Updated `Causal Discovery/_Index.md` (5→9 notes). |
