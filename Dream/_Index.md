...
**Covered by (2026-08-30):** [[Vine Copulas - Overview]], [[Pair-Copula Decomposition]], [[C-Vine and D-Vine Structures]], [[Regular Vines and Structure Selection]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-30). Sources: Aas et al. (2009), Czado (2019), Brechmann & Schepsmeier (2013) CDVine. Note: source PDFs are freely available online (JSS open access, Springer open access) but could not be downloaded due to proxy restrictions; reference `.md` files created in `raw/` instead.
...
| Vine / Pair Copulas (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Decomposition]], [[C-Vine and D-Vine Structures]], [[Regular Vines and Structure Selection]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] | 2026-08-30 |
...
| 2026-08-30 | Gap #8 (vine/pair copulas) marked 🍂 covered. All academic PDF sources (Aas et al. 2009, Brechmann & Schepsmeier 2013, Czado 2019) blocked by session proxy; created raw reference .md files in Econometrics/Dependence Modeling/raw/ documenting bibliographic info and free URLs. Created 5 vine copula notes: [[Vine Copulas - Overview]] (motivation, Sklar factorization, simplifying assumption, dimension/architecture comparison table), [[Pair-Copula Decomposition]] (Bedford-Cooke factorization theorem, h-function definitions and closed-form table for Normal/t/Clayton/Gumbel/Frank, conditional CDF recursion, 3D example), [[C-Vine and D-Vine Structures]] (star/path tree densities, 4D tree diagrams, h-function recursion per structure, application heuristics), [[Regular Vines and Structure Selection]] (R-vine proximity condition, vine matrix RVM, Dissmann greedy max-span-tree algorithm, AIC/BIC family selection, truncation formula, rvinecopulib R code), [[Vine Copula Estimation]] (vine log-likelihood, sequential IFM algorithm, marginal estimation options, asymptotic properties, 3D walkthrough). Also created [[Copula Architecture Comparison]] synthesizing vine vs factor vs Gaussian/t vs Archimedean on dimension, tail dependence, estimation cost, and decision criteria. Updated Dependence Modeling _Index.md (6→13 concepts, expanded routing summary and concept map). |
