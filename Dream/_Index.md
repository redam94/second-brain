...
**Covered by:** [[Vine Copulas - Overview]], [[Regular Vine C-vine and D-vine Structures]], [[Pair Copula Construction]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-18)
...
| Vine / Pair Copulas and Architecture Comparison (#8) | [[Vine Copulas - Overview]], [[Regular Vine C-vine and D-vine Structures]], [[Pair Copula Construction]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] | 2026-09-18 |
...
| 2026-09-18 | Gap #8 (Vine/Pair Copulas and Copula Architecture Comparison) marked 🍂 covered. Sources: VineCopula R package README and pyvinecopulib Python library README downloaded from GitHub (academic PDF sources — Aas et al. 2009, Dißmann et al. 2013 — identified but blocked by session network egress proxy). Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC motivation, simplifying assumption, historical development Joe→Bedford-Cooke→Aas et al.→Dißmann), [[Regular Vine C-vine and D-vine Structures]] (R-vine proximity condition, C-vine star structure, D-vine path structure, R-vine matrix), [[Pair Copula Construction]] (D-vine density formula, h-function definition and closed-form expressions, h-function recursion algorithm, inverse-h simulation), [[Vine Copula Estimation and Model Selection]] (sequential MLE, Dißmann greedy max-spanning-tree, AIC/BIC family selection, truncated R-vines, VineCopula R and pyvinecopulib Python code), [[Copula Architecture Comparison]] (5-architecture comparison table, Gaussian failure, factor vs vine strengths/limits, decision guide). Updated Dependence Modeling `_Index.md` (6→11 notes). |
