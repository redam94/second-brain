...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Construction and Vine Density]], [[C-Vine and D-Vine Structures]], [[Regular Vine Theory]], [[Vine Copula Estimation and Model Selection]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-26). Combined with the previously existing factor copula cluster (6 notes), the full gap — vine/pair copulas, C-vine vs D-vine, h-function, simplifying assumption, Bedford-Cooke R-vine theory, Dissmann structure selection, pyvinecopulib code — is now covered.
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction and Vine Density]], [[C-Vine and D-Vine Structures]], [[Regular Vine Theory]], [[Vine Copula Estimation and Model Selection]] | 2026-07-26 |
...
| 2026-07-26 | Run 16: Covered gap #8 (Vine Copulas / high-dimensional copula architectures). External PDF downloads were blocked by session network policy (arxiv.org policy-denied); created synthesis survey `raw/Aas-Czado-2009-Vine-Copulas-Survey.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2002), Czado (2019), Czado & Nagler (2022), Dissmann et al. (2013). Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (motivation, bivariate family table, factor vs vine landscape comparison), [[Pair Copula Construction and Vine Density]] (PCC density formula, h-function closed forms, simplifying assumption), [[C-Vine and D-Vine Structures]] (tree structure, simulation algorithms, use-case comparison table), [[Regular Vine Theory]] (proximity condition, Bedford-Cooke theorem, R-vine matrix, counting formula, truncation), [[Vine Copula Estimation and Model Selection]] (sequential MLE, full MLE, Dissmann MST algorithm, AIC family selection, VineCopula/pyvinecopulib code). Updated `Dependence Modeling/_Index.md` (6→11 notes). Gap #8 marked 🍂 covered. |
