...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Constructions]], [[C-Vine and D-Vine Architectures]], [[Vine vs Factor Copula Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-11)
...
|-----|-----------|--------------|
| Factor / Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Constructions]], [[C-Vine and D-Vine Architectures]], [[Vine vs Factor Copula Comparison]] | 2026-08-11 |
...
| 2026-08-11 | Dream ingest — Gap #8 (Factor/Vine Copulas) marked 🍂 covered. External PDF downloads blocked by network proxy (403 Forbidden for arXiv, LMU Munich, MDPI). Created synthesis survey `raw/Vine-Copulas-Aas-Czado-Survey.md` from training knowledge of Aas, Czado, Frigessi & Bakken (2009), Bedford & Cooke (2001/2002), Joe (1996), Czado (2010/2019), and Oh & Patton (2017). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (motivation, PCC definition, R-vine definition, h-function, simplifying assumption), [[Pair Copula Constructions]] (PCC density factorisation theorem, h-function recursion table for Gaussian/t/Clayton/Gumbel, sequential MLE algorithm, pair copula family table with tail dependence), [[C-Vine and D-Vine Architectures]] (star vs. path tree structures, C-vine for key drivers, D-vine for time-series Markov structure, R-vine, truncation), [[Vine vs Factor Copula Comparison]] (full architecture comparison table, when-to-use guidance, factor copula = degenerate C-vine with latent root). Updated Dependence Modeling _Index.md (6→10 notes) and Econometrics _Index.md (51→55 notes). |
