...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Decomposition]], [[C-Vine and D-Vine Structures]], [[R-Vine Structure Selection]], [[Vine Copula Estimation and Software]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-09)
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Decomposition]], [[C-Vine and D-Vine Structures]], [[R-Vine Structure Selection]], [[Vine Copula Estimation and Software]] | 2026-09-09 |
...
| 2026-09-09 | Gap #8 (Factor Copulas and High-Dimensional Copula Architectures — vine/pair copula component) marked 🍂 covered. Searched for Aas et al. (2009), Bedford & Cooke (2001/2002), Czado (2019) — all freely available on academic repositories but blocked by session egress proxy. Downloaded VineCopula R package README from GitHub (raw/VineCopula-R-Package-README.md). Created synthesis survey raw/Vine-Copulas-Literature-Survey.md from training coverage of the papers. Created 5 notes in Econometrics/Dependence Modeling/: [[Vine Copulas - Overview]] (Bedford-Cooke framework, vine structure, simplifying assumption, position vs factor copulas), [[Pair Copula Decomposition]] (PCC density factorization theorem, h-functions with formulas for Gaussian/t/Clayton/Gumbel, trivariate worked example), [[C-Vine and D-Vine Structures]] (star vs path tree topologies, density formulas, 4-d worked examples, comparison table), [[R-Vine Structure Selection]] (Dissmann 2013 MST algorithm, proximity condition, truncated vines, family selection by AIC/BIC), [[Vine Copula Estimation and Software]] (sequential MLE procedure, GoF via Rosenblatt transform, VineCopula R functions, pyvinecopulib Python API). Updated Dependence Modeling _Index.md (6 → 11 notes). |
