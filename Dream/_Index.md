...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-03)
...
| Causal Structure Learning — PC & GES (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-08-03 |
...
| 2026-08-03 | Ingest run: addressed gap #9 (Causal Structure Learning — PC algorithm and GES). Searched arXiv, JMLR, and Semantic Scholar for Colombo & Maathuis (2014, arXiv:1211.3295) and Chickering (2002, JMLR 3:507-554) — all freely available but blocked by session network policy (proxy denied CONNECT to arxiv.org and jmlr.org). Created synthesis survey `raw/PC-GES-Causal-Discovery-Survey.md` from training knowledge of Spirtes et al. (2000), Chickering (2002), Colombo & Maathuis (2014), Meek (1995), Verma & Pearl (1990). Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, Meek's rules R1–R4, covered edge reversals), [[PC Algorithm]] (three phases, PC-stable order-independence fix, CI test comparison, consistency theorem, FCI extension), [[GES - Greedy Equivalence Search]] (FES/BES phases, BIC decomposability, Meek Conjecture proof, consistency theorem, FGES). Updated `Causal Discovery/_Index.md` (5→8 notes, added paradigm comparison table). Gap #9 marked 🍂 covered. |
