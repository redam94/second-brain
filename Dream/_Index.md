...
**Covered by:** [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton and Independence Tests]], [[PC Algorithm - Orientation and CPDAGs]], [[GES Algorithm - Overview]], [[Constraint vs Score-Based Causal Discovery]] (all in `Causal Discovery/`, created 2026-09-01)
...
| Causal Structure Learning — PC/GES (#9) | [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton and Independence Tests]], [[PC Algorithm - Orientation and CPDAGs]], [[GES Algorithm - Overview]], [[Constraint vs Score-Based Causal Discovery]] | 2026-09-01 |
...
| 2026-09-01 | Gap #9 (Causal Structure Learning: PC/GES) marked 🍂 covered. External PDF repositories (arXiv.org, jmlr.org, semanticscholar.org, github.io) all blocked by session egress policy; created `raw/pc-ges-causal-discovery-sources.md` as a comprehensive literature reference from training knowledge of Spirtes, Glymour & Scheines (2000), Kalisch & Bühlmann (2007, JMLR 8:613–636), Chickering (2002, JMLR 3:507–554), Meek (1995), Verma & Pearl (1990), and Colombo & Maathuis (2014). Created 5 notes in `Causal Discovery/`: [[PC Algorithm - Overview]] (assumptions, two phases, faithfulness, CPDAG, FCI extension), [[PC Algorithm - Skeleton and Independence Tests]] (adjacency search algorithm, partial correlation Fisher Z-test, PC-stable variant, Kalisch-Bühlmann high-dimensional consistency theorem, $O(d^{q+2})$ complexity), [[PC Algorithm - Orientation and CPDAGs]] (v-structure identification, Verma-Pearl Markov equivalence theorem, Meek's R1–R4 orientation rules completeness theorem, identifiability limits table), [[GES Algorithm - Overview]] (BIC/BDeu scoring, two-phase FES/BES, Insert/Delete operators, Chickering 2002 Theorem 15 optimality, FGES parallelization), [[Constraint vs Score-Based Causal Discovery]] (full comparison: PC vs GES vs NOTEARS — assumptions, failure modes, strengths, practical guidance, ABM connection). Updated `Causal Discovery/_Index.md` (5→10 notes + source file). |
