...
**Covered by (2026-09-11):** [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`). Sources: Bedford & Cooke (2001/2002), Aas et al. (2009), Dißmann et al. (2013), Czado (2019). Note: PDF downloads were unavailable (network-blocked session); notes written from training knowledge.
...
| Factor/Vine Copulas and Copula Architecture Comparison (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] | 2026-09-11 |
...
| 2026-09-11 | Ingest: Gap #8 (Factor/Vine Copulas and Copula Architecture Comparison) marked 🍂 covered. Searched for free PDF versions of Aas et al. (2009), Bedford & Cooke (2001/2002), Dißmann et al. (2013), Czado (2019) — all blocked by session egress proxy (arXiv, TUM mediaTUM, Project Euclid, SSRN unreachable). Created source-reference file `raw/vine-copulas-sources.md`. Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (Bedford-Cooke R-vine framework, density factorization, simplifying assumption, C/D/R-vine types); [[Pair Copula Construction]] (h-function definition with closed-form examples, Bedford-Cooke factorization theorem, recursive conditional CDF computation, 3-variable example); [[C-Vine and D-Vine Structures]] (star vs path tree structure, explicit d-dimensional density formulas, when-to-use guidance, 4-variable worked examples for each); [[Vine Copula Estimation]] (Dißmann's MST algorithm, per-edge AIC family selection, truncated vines, `pyvinecopulib` code, 5-variable estimation walkthrough); [[Copula Architecture Comparison]] (5-architecture comparison table, curse of dimensionality for d=100, tail-dependence comparison, practical guidance, S&P 100 factor-vs-vine case study). Updated `Dependence Modeling/_Index.md` (6→11 notes). |
