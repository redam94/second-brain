...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-09-19). Sources: Spirtes, Glymour & Scheines (2000); Meek (1995); Chickering (2002, *JMLR*); Verma & Pearl (1990). PDFs freely available but inaccessible from this session (network egress policy); reference list in [[raw/constraint-score-based-sources.md]].
...
| Causal Structure Learning: PC/GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-09-19 |
...
| 2026-09-19 | Gap #9 (Causal Structure Learning from Data: PC algorithm and GES) marked 🍂 covered. The NOTEARS cluster already covered continuous optimization; this run adds constraint-based and score-based paradigms. No PDFs downloadable (jmlr.org and arxiv.org blocked by session egress policy; papers are freely available). Source reference list created at `raw/constraint-score-based-sources.md`. Created 3 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Markov property, Markov equivalence theorem Verma & Pearl 1990, d-separation, v-structures, CPDAG definition, Meek orientation rules R1–R4, faithfulness), [[PC Algorithm]] (3 phases: skeleton via CI tests, v-structure orientation from separating sets, Meek edge completion; Fisher z-test; consistency theorem; complexity $O(d^{q+2})$; stable PC; toy 4-variable example), [[GES - Greedy Equivalence Search]] (score equivalence, decomposability, local consistency; BIC/BDeu table; forward Insert operator; backward Delete operator; turning phase Hauser & Bühlmann 2012; score-consistency theorem Chickering 2002 Thm. 15; PC vs GES vs NOTEARS comparison table). Updated `Causal Discovery/_Index.md` (5→8 notes; new paradigm comparison table). |
