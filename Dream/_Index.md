...
**Covered by:** [[CPDAG and Markov Equivalence]], [[PC Algorithm - Overview]], [[GES - Greedy Equivalence Search]], [[Causal Discovery Methods - Comparison]] (all in `Causal Discovery/`, created 2026-08-31)

**Note on sources:** PDF downloads were blocked by the session's network egress policy (jmlr.org and arxiv.org denied). Notes were written from training-knowledge of the source papers; reference files created in `raw/` citing the canonical open-access URLs for future download.
...
|-----|-----------|--------------|
| Causal Structure Learning — PC & GES (#9) | [[CPDAG and Markov Equivalence]], [[PC Algorithm - Overview]], [[GES - Greedy Equivalence Search]], [[Causal Discovery Methods - Comparison]] | 2026-08-31 |
...
| 2026-08-31 | Gap #9 (Causal Structure Learning — PC & GES) marked 🍂 covered. Sources: Spirtes, Glymour & Scheines (2000), Chickering (2002), Kalisch & Bühlmann (2007) — all freely available on JMLR/arXiv but blocked by session network egress policy (jmlr.org and arxiv.org denied). Reference files created in `Causal Discovery/raw/`. 4 notes written from training knowledge: [[CPDAG and Markov Equivalence]] (Markov equivalence theorem, CPDAG existence/uniqueness, Meek rules R1–R4), [[PC Algorithm - Overview]] (3-phase pseudocode, faithfulness/sufficiency defs, correctness theorem, high-dimensional consistency, CI test options, complexity), [[GES - Greedy Equivalence Search]] (BIC score, Meek Conjecture proof, 2-phase pseudocode, Insert/Delete operators, consistency theorem), [[Causal Discovery Methods - Comparison]] (PC vs GES vs NOTEARS decision table, ABM context, hybrid methods). Updated `Causal Discovery/_Index.md` (5→9 notes). |
