...
**Covered by:** [[Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton Discovery]], [[PC Algorithm - Orientation Rules]], [[GES - Overview]] (all in `Causal Discovery/`, created 2026-09-08). Together with the existing NOTEARS notes, all three major paradigms (constraint-based, score-based greedy, continuous-optimization) are now covered.
...
| Causal Structure Learning — PC + GES (#9) | [[Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton Discovery]], [[PC Algorithm - Orientation Rules]], [[GES - Overview]] | 2026-09-08 |
...
| 2026-09-08 | Ingest run — Gap #9 (Causal Structure Learning from Data, PC + GES). Selected gap #9 (🌿 still relevant): NOTEARS was covered; PC algorithm and GES were absent. PDF downloads blocked by network proxy policy (jmlr.org, archive.illc.uva.nl, arxiv.org all return 403). Created 5 notes in `Causal Discovery/` from comprehensive training knowledge of the algorithms: [[Equivalence Classes and CPDAGs]] (Markov equivalence theorem, CPDAG definition, compelled/reversible edges, identifiability table); [[PC Algorithm - Overview]] (two-phase design, soundness/completeness theorem, complexity, variants table, PC vs GES comparison); [[PC Algorithm - Skeleton Discovery]] (adjacency restriction lemma, skeleton algorithm pseudocode, Fisher Z formula, PC-stable, 4-variable example); [[PC Algorithm - Orientation Rules]] (v-structure detection via sepsets, Meek's 4 rules R1–R4, completeness theorem, Phase 2 pseudocode); [[GES - Overview]] (BIC/BGe/BDeu scores, FES+BES algorithm, Insert/Delete operators, Meek Conjecture proof, GES consistency theorem, FGES, GES vs NOTEARS table). Updated `Causal Discovery/_Index.md` (5→10 notes, new concept map rows, Sources section). Gap #9 marked 🍂 covered. |
