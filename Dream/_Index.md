...
**Covered by:** [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton and Orientation]], [[GES - Overview]], [[GES - Forward and Backward Search]] (all in `Causal Discovery/`, created 2026-08-25)
...
| Causal Structure Learning from Data (#9) | [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton and Orientation]], [[GES - Overview]], [[GES - Forward and Backward Search]] | 2026-08-25 |
...
| 2026-08-25 | Gap #9 (Causal Structure Learning) marked 🍂 covered. Searched for Spirtes et al. (2000) *Causation, Prediction, and Search* and Chickering (2002) JMLR GES paper — both freely available but blocked by session network proxy (arXiv, jmlr.org, semanticscholar all returned 403). Created `raw/PC-GES-canonical-references.md` documenting canonical citations and access paths. Read PC and GES algorithm implementations from `py-why/causal-learn` on GitHub (raw.githubusercontent.com accessible). Created 4 notes in `Causal Discovery/`: [[PC Algorithm - Overview]] (3 assumptions: Causal Markov / Faithfulness / Causal Sufficiency; Markov equivalence; CPDAG definition; complexity table; FCI extension), [[PC Algorithm - Skeleton and Orientation]] (Phase 1 depth-$k$ CI testing and stable PC; Phase 2 v-structure detection; Phase 3 Meek rules R1–R4 with complete statements; examples), [[GES - Overview]] (score-equivalence; Gaussian BIC score; CPDAG neighbourhood theorem; 3-phase algorithm; FES completeness + BES soundness consistency theorem; PC vs. GES comparison table), [[GES - Forward and Backward Search]] (Insert/Delete/Turn operator formal definitions + validity conditions + score-change formulas; FES and BES pseudocode; examples). Updated `Causal Discovery/_Index.md` (5→9 notes; routing summary updated; Concept Map extended; Notes section reorganised by paradigm). |
