...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm - Overview]], [[Conditional Independence Testing for Causal Discovery]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-07-08)
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm - Overview]], [[Conditional Independence Testing for Causal Discovery]], [[GES - Greedy Equivalence Search]] | 2026-07-08 |
...
| 2026-07-08 | Run 14: Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Primary sources (Spirtes, Glymour & Scheines 2000; Chickering 2002 JMLR; Verma & Pearl 1990; Meek 1995) are freely available but blocked by session egress proxy policy (arxiv.org, jmlr.org, cs.cmu.edu denied). Created synthesis survey `raw/PC-GES-Synthesis-Survey.md` from training knowledge. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl equivalence theorem, CPDAG definition, Meek's 4 rules, identifiability limit), [[Conditional Independence Testing for Causal Discovery]] (Fisher z-transform, G² test, KCI/RCIT for non-parametric, BH-FDR multiple testing, sparsity–accuracy trade-off), [[PC Algorithm - Overview]] (3-phase algorithm, consistency theorem, faithfulness assumption, PC-stable, FCI extension), [[GES - Greedy Equivalence Search]] (decomposable scores BIC/BDe, Insert/Delete operators, FES+BES phases, Meek conjecture proof, consistency theorem). Updated `Causal Discovery/_Index.md` (5→9 notes, added three-way PC/GES/NOTEARS comparison table). |
