...
**Covered by:** [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Pair Copula Selection and Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-18)
...
| Factor Copulas and High-Dimensional Copula Architectures (#8) | [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Pair Copula Selection and Estimation]], [[Copula Architecture Comparison]] | 2026-07-18 |
...
| 2026-07-18 | Gap #8 (Factor Copulas and High-Dimensional Copula Architectures) marked 🍂 covered — vine/pair copulas were the remaining absent component. Searched arXiv, Munich institutional repository, and Project Euclid for Aas et al. (2009) and Bedford & Cooke (2002) — all academic PDF domains blocked by session network policy. Created synthesis survey `raw/Vine-Copulas-Aas2009-Bedford2002-Czado2019-Synthesis.md` from training knowledge covering: PCC factorisation, h-function, C-vine and D-vine general density formulae, proximity condition (Bedford & Cooke 2002), bivariate copula family table (Gaussian/t/Clayton/Gumbel/Frank/Joe/BB1/BB7/rotations), sequential MLE algorithm, simplifying assumption, AIC/BIC family selection, and factor vs vine comparison. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC idea, 3-var illustration, h-function, Norwegian data example), [[C-Vine and D-Vine Structures]] (proximity condition, formal tree definitions, general density formulae for C-vine and D-vine, R-vine generalisation, 4-variable edge listing), [[Pair Copula Selection and Estimation]] (sequential MLE algorithm, simplifying assumption, bivariate copula family table with tail dependence, AIC selection, VineCopula R code, 3-variable worked example), [[Copula Architecture Comparison]] (comparison table across 4 architectures, decision framework by dimension/factor story/density requirements, S&P 100 and Norwegian examples). Updated Dependence Modeling _Index.md (6→10 notes, new vine copula section added). |
