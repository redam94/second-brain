...
**Covered by:** [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton Phase]], [[PC Algorithm - Orientation Phase]], [[GES - Overview]], [[Causal Structure Learning - Paradigm Comparison]] (all in `Causal Discovery/`, created 2026-08-22)
...
| Causal Structure Learning / PC + GES (#9) | [[PC Algorithm - Overview]], [[PC Algorithm - Skeleton Phase]], [[PC Algorithm - Orientation Phase]], [[GES - Overview]], [[Causal Structure Learning - Paradigm Comparison]] | 2026-08-22 |
...
| 2026-08-22 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Proxy restrictions blocked all direct PDF downloads (arXiv, JMLR blocked). Notes written from training knowledge of canonical papers. Created 5 notes in `Causal Discovery/`: [[PC Algorithm - Overview]] (3 assumptions, two-phase structure, CPDAG definition, Kalisch & Bühlmann 2007 high-dimensional consistency), [[PC Algorithm - Skeleton Phase]] (skeleton procedure Def., Fisher's z-test Ex., sep-sets Def., complexity analysis), [[PC Algorithm - Orientation Phase]] (v-structure Def., Meek R1–R4 rules Def., CPDAG reading Def., completeness theorem), [[GES - Overview]] (score requirements Def., BIC score, Insert/Delete/Turn algorithm Def., Chickering Thm. 15, Meek conjecture, FGS note), [[Causal Structure Learning - Paradigm Comparison]] (three-paradigm overview with assumptions/consistency/computational tables). Updated `Causal Discovery/_Index.md` (5→10 notes). Updated `DAG Structure Learning Problem.md` to wikilink PC and GES in the landscape table and See Also. Sources cited: Spirtes, Glymour & Scheines (2000); Chickering (2002) JMLR 3:507–554; Kalisch & Bühlmann (2007) JMLR 8:613–636. |
