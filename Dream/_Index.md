...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-19)
...
| Factor & Vine Copulas / Copula Architectures (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] | 2026-07-19 |
...
| 2026-07-19 | Gap #8 (Factor/Vine Copulas / Copula Architectures) marked 🍂 covered. Searched for free PDFs of Aas et al. (2009), Bedford & Cooke (2002), and Czado (2010) — URLs found (LMU Munich epub.ub.uni-muenchen.de and TU Munich mediaTUM) but all external hosts blocked by session network policy. Created synthesis survey `raw/Vine-Copula-Survey.md` from training knowledge of the three papers following the PSM (gap #1) precedent. Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (motivation, PCC idea, regular vine definition, Bedford & Cooke 2002, comparison with factor copulas), [[Pair Copula Construction]] (formal density, h-function definition, h-function table for 6 families, recursive tree computation algorithm), [[C-Vine and D-Vine Structures]] (star-tree C-vine, path-tree D-vine, R-vine MST structure selection, market-factor and yield-curve examples), [[Vine Copula Estimation and Selection]] (sequential MLE, consistency theorem, AIC family selection, Vuong test, independence truncation, MST algorithm, VineCopula R code, pyvinecopulib Python code), [[Copula Architecture Comparison]] (7-column table: Gaussian/t/Archimedean/factor/C-vine/D-vine/R-vine; decision rules; 7-variable AIC example; N=100 discussion). Updated Dependence Modeling _Index.md (6→11 notes). |
