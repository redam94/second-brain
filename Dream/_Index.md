...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, added 2026-08-12)
...
| Causal Structure Learning (#9) — PC + GES | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-08-12 |
...
| 2026-08-12 | Dream ingest run: addressed gap #9 (Causal Structure Learning from Data — PC algorithm + GES). No new PDFs downloaded (jmlr.org and arxiv.org blocked by session network policy; primary sources Chickering 2002 and Spirtes et al. 2000 cited by name). Used existing `raw/1803.01422-NOTEARS.pdf` (already in vault) as bibliographic anchor for background on PC/GES as comparison baselines (NOTEARS §2.2, §5). Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (d-separation, v-structures, Verma-Pearl theorem, CPDAG definition, Meek rules R1–R4, faithfulness), [[PC Algorithm]] (full 3-phase pseudocode, partial correlation CI test + Fisher z, Kalisch & Bühlmann high-dim. consistency, PC-stable, software), [[GES - Greedy Equivalence Search]] (BIC score, FES/BES phases, CPDAG operators, Meek conjecture as Chickering 2002 Thm 15, GES consistency theorem, FGS variant). Updated `Causal Discovery/_Index.md` (5→8 notes). Gap #9 marked 🍂 covered. |
