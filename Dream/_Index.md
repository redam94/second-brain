...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Constructions]], [[Regular Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, ingested 2026-07-22)
...
| Factor/Vine Copulas and Copula Architecture (#8) | [[Vine Copulas - Overview]], [[Pair Copula Constructions]], [[Regular Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] | 2026-07-22 |
...
| 2026-07-22 | Run 16: addressed gap #8 (Vine Copulas / Copula Architectures). External PDF downloads (arXiv, LMU Munich, EconStor) all blocked by session network proxy. Created synthesis survey `raw/Vine-Copula-Survey-Synthesis.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2002), Dißmann et al. (2013), Czado (2010), Joe (1996). Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (motivation, PCC idea, position vs other architectures, key papers), [[Pair Copula Constructions]] (trivariate Joe 1996 factorisation, $N$-dimensional Bedford & Cooke theorem, h-functions with closed forms for Gaussian/$t$/Clayton/Gumbel/Frank, simplifying assumption, 4-variable D-vine example), [[Regular Vine Structures]] (R-vine proximity condition, C-vine star geometry, D-vine path geometry, edge label notation, C/D/R-vine comparison table), [[Vine Copula Estimation]] (pseudo-observations, Dißmann greedy max-spanning-tree, family selection by AIC, sequential vs joint ML, truncation, full VineCopula R code), [[Copula Architecture Comparison]] (6-row table: Gaussian/$t$/Archimedean/vine/factor; strengths/limits of vine vs factor; decision guide; DAX sector returns example). Updated `Dependence Modeling/_Index.md` (6→11 notes) and `Econometrics/_Index.md` (51→56 notes). Gap #8 marked 🍂 covered. |
