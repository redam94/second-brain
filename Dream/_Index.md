...
**Covered by:** [[Rosenbaum and Rubin 1983 - Overview]], [[Propensity Score Definition and Properties]], [[Propensity Score Matching Methods]], [[Covariate Balance Diagnostics]] (all in `Econometrics/Identification Strategies/`, ingested 2026-07-01)
...
| Propensity Score Methods and IPW (#1) | [[Rosenbaum and Rubin 1983 - Overview]], [[Propensity Score Definition and Properties]], [[Propensity Score Matching Methods]], [[Covariate Balance Diagnostics]] | 2026-07-01 |
...
| 2026-07-01 | Run 13: Ingested Gap #1 (Propensity Score Methods and IPW). Source PDFs (Rosenbaum & Rubin 1983 and Imbens 2004) were found freely available on the web but could not be downloaded due to session network policy (403 on all external hosts); created markdown source-reference files in `Research/raw/` with bibliographic info and content summaries. Created 4 notes in `Econometrics/Identification Strategies/`: [[Rosenbaum and Rubin 1983 - Overview]], [[Propensity Score Definition and Properties]] (Theorem 1 balancing property + Corollary ignorability sufficiency), [[Propensity Score Matching Methods]] (nearest-neighbor, caliper, subclassification, full matching, CEM), [[Covariate Balance Diagnostics]] (SMD, variance ratio, overlap plots, Love plots, iterative workflow). Updated Identification Strategies `_Index.md` (concept_count 16 → 20). Gap #1 marked 🍂 covered. |
