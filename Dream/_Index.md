...
**Covered by (2026-08-18):** [[Causal Markov and Faithfulness]], [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[PC Algorithm - Phases]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`). Sources: Spirtes, Glymour & Scheines (2000); Kalisch & Bühlmann (2007) JMLR 8:613–636; Chickering (2002) JMLR 3:507–554; Meek (1995) UAI. PDFs could not be downloaded (session egress proxy blocks arxiv.org and jmlr.org); bibliography stubs created at `raw/spirtes-glymour-scheines-2000-CPS.bib` and `raw/chickering-2002-ges.bib`.
...
| Causal Structure Learning from Data (#9) | [[Causal Markov and Faithfulness]], [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[PC Algorithm - Phases]], [[GES - Greedy Equivalence Search]] | 2026-08-18 |
...
| 2026-08-18 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. PC algorithm and GES were entirely absent from the Causal Discovery folder; NOTEARS already covered. Searched for free PDFs of Spirtes et al. (2000) and Chickering (2002) — both freely available at MIT Press / arXiv / JMLR but blocked by session egress proxy (arxiv.org and jmlr.org return 403). Created bibliography stubs at `raw/spirtes-glymour-scheines-2000-CPS.bib` and `raw/chickering-2002-ges.bib` with URLs for later download. Created 5 notes in `Causal Discovery/`: [[Causal Markov and Faithfulness]] (CMC, faithfulness, causal sufficiency, identifiability theorem, strong faithfulness for high-d consistency), [[Markov Equivalence Classes and CPDAGs]] (v-structure definition, Verma-Pearl theorem, MEC, CPDAG construction, Meek's conjecture), [[PC Algorithm - Overview]] (paradigm comparison table, assumptions, algorithm summary, CI test options, PC vs GES vs NOTEARS comparison table), [[PC Algorithm - Phases]] (skeleton phase with CI tests + high-dimensional consistency theorem, v-structure phase, Meek R1–R4 completeness theorem, PC-stable variant), [[GES - Greedy Equivalence Search]] (decomposable/locally consistent score, FES + BES algorithms, Insert/Delete operators, score-gain formula, GES consistency theorem, FGES extension, interventional GES). Updated `Causal Discovery/_Index.md`: concept_count 5→10, new routing summary, extended concept map + notes sections. |
