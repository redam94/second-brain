...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Decomposition]], [[C-vine and D-vine Structures]], [[Vine Copula Estimation and Selection]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-13)
...
| Factor Copulas / Vine Copula Architectures (#8) | [[Vine Copulas - Overview]], [[Pair Copula Decomposition]], [[C-vine and D-vine Structures]], [[Vine Copula Estimation and Selection]] | 2026-09-13 |
...
| 2026-09-13 | Gap #8 (Factor Copulas / Vine Copula Architectures) marked 🍂 covered. Aas et al. (2009) "Pair-copula constructions of multiple dependence" could not be downloaded (network egress policy blocks academic repositories); created synthesis stub `raw/Aas-2009-Pair-Copula-Constructions.md` from training knowledge of the paper. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC idea, regular vine definition, comparison table factor vs vine architectures, simplifying assumption), [[Pair Copula Decomposition]] (factorization theorem $f=\prod f_k\cdot\prod c_{jk\|D}$, h-function definition $h(u\|v)=\partial C/\partial v$, h-function formulas for Gaussian/$t$/Clayton/Gumbel families, recursive computation algorithm, 3-variable C-vine worked example), [[C-vine and D-vine Structures]] (C-vine star topology with 4-var example and general formula, D-vine path topology with 4-var example and general formula, comparison table, truncated vine definition), [[Vine Copula Estimation and Selection]] (sequential MLE theorem with consistency + asymptotic normality + sandwich variance, full joint MLE, pair copula family selection AIC/BIC + 4 rotations for asymmetry, structure selection via maximum spanning tree on Kendall's $\tau$, software table VineCopula/rvinecopulib/pyvinecopulib, 4-variable D-vine estimation walkthrough). Updated Dependence Modeling `_Index.md` (6 → 10 concepts). |
