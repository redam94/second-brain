...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Decomposition]], [[C-vine and D-vine Structures]], [[Regular Vine Copulas]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-16)
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Decomposition]], [[C-vine and D-vine Structures]], [[Regular Vine Copulas]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] | 2026-07-16 |
...
| 2026-07-16 | Gap #8 (Factor Copulas & Vine Copulas) marked 🍂 covered. PDF downloads blocked by session network policy (arxiv.org and institutional repos). Created synthesis survey `raw/Vine-Copula-Synthesis-Survey.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2002), Dißmann et al. (2013), Joe (1996), Czado (2019). Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (pair-copula construction, simplifying assumption, D-vine 3-variable example), [[Pair-Copula Decomposition]] (full PCC density theorem, h-function definition with closed forms for Gaussian/Clayton/Gumbel/t/Frank, h-function recursion, 3-variable worked example), [[C-vine and D-vine Structures]] (formal C-vine and D-vine definitions, 4-variable worked examples, comparison table, ordering selection heuristic), [[Regular Vine Copulas]] (vine definition with proximity condition, conditioned/conditioning sets, R-vine structure matrix, Bedford-Cooke density theorem with proof sketch), [[Vine Copula Estimation and Model Selection]] (Stage 1 pseudo-observations, Stage 2 Dißmann greedy spanning tree structure selection, Stage 3 AIC family selection, sequential vs joint MLE, truncation, VineCopula R and pyvinecopulib Python code). Also created [[Copula Architecture Comparison]] synthesizing factor copula vs vine copula (comparison table, when to use each, tail dependence comparison, Gaussian copula failure, S&P 100 and weather-station application examples). Updated `Dependence Modeling/_Index.md` (6→11 notes). |
