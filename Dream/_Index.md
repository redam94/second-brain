...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all added 2026-08-15, source: Chickering & Meek 2015 SGES paper). NOTEARS was already covered by [[NOTEARS - Overview]], [[DAG Structure Learning Problem]], [[Smooth Characterization of Acyclicity]], [[NOTEARS Algorithm]], [[NOTEARS Experiments]] (added 2026-06-22).

**Fully addressed (2026-08-15):** The `Causal Discovery/` subfolder now covers all three major algorithm families: constraint-based (PC), score-based (GES/SGES), and continuous-optimization (NOTEARS), plus the shared theoretical foundation (Markov equivalence classes, CPDAGs, Meek's rules, IMAP ordering).
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-08-15 |
...
| 2026-08-15 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Downloaded Chickering & Meek (2015) SGES paper from Microsoft Research (only freely-accessible academic source reachable under session network policy). Created 3 notes in `Research/Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (MEC definition, Verma & Pearl 1991 skeleton+v-structure theorem, PDAG/CPDAG definitions, Meek's 4 rules, IMAP ordering, worked examples), [[PC Algorithm]] (causal Markov/faithfulness/causal sufficiency assumptions, 3-phase algorithm, Kalisch & Bühlmann 2007 high-dimensional consistency, PC-stable), [[GES - Greedy Equivalence Search]] (decomposable BIC scoring, IMAP lattice, FES/BES phases, Chickering 2002 consistency theorem, SGES polynomial-time variant, covered edges, PC vs GES comparison table). Updated `Research/Causal Discovery/_Index.md` (5→9 notes, extended routing summary and concept map). |
