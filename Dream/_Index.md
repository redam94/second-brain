...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-21)
...
| Factor/Vine Copulas and High-Dimensional Copula Architectures (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]] | 2026-08-21 |
...
| 2026-08-21 | Run 20: Gap #8 (Vine/Pair Copulas) marked 🍂 covered. arXiv and university PDF domains blocked by egress policy; created synthesis survey `raw/Vine-Copula-Synthesis-Survey.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2001, 2002), Czado (2019), Czado & Nagler (2022), Dissmann et al. (2013). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC motivation, comparison table with factor copulas, three-variable C-vine illustration), [[Pair-Copula Construction]] (density factorisation, $h$-functions with closed forms, simplifying assumption, D-vine worked example), [[C-Vine and D-Vine Structures]] (star vs path topology, pair tables for $d=4$, proximity condition, when to use each, equity-returns and time-series examples), [[Vine Copula Estimation and Selection]] (sequential MLE theorem, bivariate family menu, MST structure selection, truncation level, `rvinecopulib`/`VineCopula` software). Updated `Econometrics/Dependence Modeling/_Index.md` (6→10 notes). |
