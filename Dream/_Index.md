...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[Conditional Independence Testing]], [[GES - Greedy Equivalence Search]], [[Causal Structure Learning - Method Comparison]] (all in `Causal Discovery/`, created 2026-09-24). Note: PDF downloads were blocked by the session's network egress policy; notes were written from primary knowledge of Spirtes, Glymour & Scheines (2000) and Chickering (2002). The JMLR paper is freely available at jmlr.org/papers/v3/chickering02b.
...
| Causal Structure Learning — PC & GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[Conditional Independence Testing]], [[GES - Greedy Equivalence Search]], [[Causal Structure Learning - Method Comparison]] | 2026-09-24 |
...
| 2026-09-24 | Gap #9 (Causal Structure Learning — PC & GES) marked 🍂 covered. Selected gap #9 (🌿 still relevant) as the highest-priority partial gap. PDF downloads blocked by session network egress policy (jmlr.org, arxiv.org, semanticscholar.org all policy-denied). Notes written from primary knowledge of the canonical papers: Spirtes & Glymour (1991), Spirtes, Glymour & Scheines (2000) *CPS* Ch. 5, Chickering (2002) *JMLR* 3:507–554. Created 5 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (MEC graphical characterization, CPDAG def, Meek rules R1–R4, 3-node example), [[PC Algorithm]] (assumptions, skeleton pseudocode with sep-sets, v-structure orientation, Meek dispatch, consistency theorem, variants table), [[Conditional Independence Testing]] (Fisher Z-test with full statistic derivation, G² test, KCI kernel test, comparison table), [[GES - Greedy Equivalence Search]] (FES/BES pseudocode, Insert/Delete operators, BIC score decomposability, Chickering consistency theorem, Meek Conjecture proof context, Hauser–Bühlmann Turn operator), [[Causal Structure Learning - Method Comparison]] (PC vs GES vs NOTEARS feature table, core tradeoffs, empirical benchmark rankings, method selection guide). Updated `_Index.md` (5→10 notes, new routing summary covering all three paradigms). Updated `DAG Structure Learning Problem.md` used_by field. |
