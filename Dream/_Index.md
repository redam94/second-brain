...
**Covered by (2026-09-26):** [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Regular Vines and the R-Vine Matrix]], [[Vine Copula Estimation and Model Selection]] — all in `Econometrics/Dependence Modeling/`.

Sources: Aas, Czado, Frigessi & Bakken (2009); Bedford & Cooke (2001, 2002); Dissmann et al. (2013). PDFs unavailable for download (proxy policy blocks arxiv.org and academic repositories); notes written from training knowledge of these well-established papers.
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Regular Vines and the R-Vine Matrix]], [[Vine Copula Estimation and Model Selection]] | 2026-09-26 |
...
| 2026-09-26 | Gap #8 (Factor Copulas & Vine Copulas) marked 🍂 covered. Vine/pair copulas (C-vine, D-vine, R-vine) were the remaining absent component. Searched arXiv (Dissmann et al. arXiv:1202.2002), INRIA, LMU Munich, CRAN, and PMC for free PDFs — all domains blocked by session proxy policy. Created 5 notes in `Econometrics/Dependence Modeling/` from training knowledge of Aas et al. (2009), Bedford & Cooke (2001, 2002), and Dissmann et al. (2013): [[Vine Copulas - Overview]] (landscape comparison table, Joe-Bedford-Cooke-Aas history, simplifying assumption), [[Pair Copula Construction]] (PCC density formula, h-function table for Gaussian/$t$/Clayton/Gumbel, trivariate example), [[C-Vine and D-Vine Structures]] (star/path topologies, 4-variable density formulas, comparison table), [[Regular Vines and the R-Vine Matrix]] (proximity condition, vine matrix, MST model selection, truncated vines, VineCopula/rvinecopulib), [[Vine Copula Estimation and Model Selection]] (sequential MLE, joint MLE, AIC family selection, simulation, factor vs. vine comparison). Updated `Econometrics/Dependence Modeling/_Index.md` (6→11 notes). |
