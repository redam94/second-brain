...
**Covered by:** [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-02)
...
| Factor & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Copula Architecture Comparison]] | 2026-07-02 |
...
| 2026-07-02 | Gap #8 (Factor & Vine Copulas) fully marked 🍂 covered. Factor copula half already covered since 2026-06-22. Searched for free PDFs: Aas et al. (2009) *Insurance: Mathematics and Economics* (paywalled), Czado (2019) Springer (paywalled) — all blocked by session network policy. Created synthesis survey `raw/Vine-Copula-Aas-Czado-Survey.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2001/2002), and Joe (1996). Created 3 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (pair copula construction, regular vine/R-vine definition Bedford & Cooke, PCC density decomposition, simplifying assumption, $d=3$ example), [[C-Vine and D-Vine Structures]] (canonical star-topology vs drawable path-topology, h-function closed forms for Gaussian/$t$/Clayton/Gumbel, sequential estimation $d=4$ worked example, structure selection), [[Copula Architecture Comparison]] (dimension–flexibility trade-off table, Normal/$t$/Archimedean/factor/vine comparison, when-to-use guide, Oh & Patton critique of vine copulas for $d \geq 50$, factor-vine complementarity by dimension regime). Updated Dependence Modeling _Index.md (6→9 notes) and Econometrics _Index.md (51→54 notes). |
