...
**Covered by (2026-08-24):** [[Vine Copulas - Overview]], [[Pair Copula Decompositions]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-24). Sources: Aas, Czado, Frigessi & Bakken (2009); Bedford & Cooke (2002); Brechmann & Schepsmeier (2013). Note: PDF downloads blocked by network proxy in this session; notes written from training knowledge of primary sources.
...
| Vine / Pair Copulas and Copula Architecture Comparison (#8, partial) | [[Vine Copulas - Overview]], [[Pair Copula Decompositions]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] | 2026-08-24 |
...
| 2026-08-24 | Ingest run (vine copulas / gap #8 completion): Gap #8 (Factor Copulas and High-Dimensional Copula Architectures) marked 🍂 covered. The vine/pair copula sub-gap was addressed by creating 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (Bedford-Cooke history, PCC definition, simplifying assumption), [[Pair Copula Decompositions]] (h-function definition and table for 4 families, density factorization for d=3 and d=4 with D-vine and C-vine examples), [[C-Vine and D-Vine Structures]] (R-vine proximity condition, C-vine star structure, D-vine path structure, graphical examples for d=5, dimension threshold table), [[Vine Copula Estimation]] (Dissmann max-spanning-tree algorithm, sequential MLE theorem, copula family AIC/BIC table, VineCopula R and pyvinecopulib Python code examples), [[Copula Architecture Comparison]] (5-architecture feature table, tail-dependence table, factor-vs-vine trade-off callout, practical dimension thresholds, financial guidance). Also created `raw/Aas-2009-vine-copulas-source-notes.md` documenting sources (Aas et al. 2009, Bedford & Cooke 2001/2002, Brechmann & Schepsmeier 2013, Czado & Nagler 2022). Note: network proxy blocked all PDF downloads (arxiv.org, jstatsoft.org, epub.ub.uni-muenchen.de all returned 403); notes written from training knowledge of primary sources. Updated `Econometrics/Dependence Modeling/_Index.md` (6 → 11 notes). |
