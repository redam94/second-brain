...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Causal Discovery Algorithms - Comparison]] (all in `Causal Discovery/`, created 2026-07-11)
...
| Causal Structure Learning (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Causal Discovery Algorithms - Comparison]] | 2026-07-11 |
...
| 2026-07-11 | Gap #9 (Causal Structure Learning) marked 🍂 covered. PDFs for Chickering (2002) JMLR, Spirtes-Glymour-Scheines (2000), and Colombo-Maathuis (2014) unavailable due to network policy (arXiv, JMLR blocked). Created synthesis survey `raw/PC-GES-causal-structure-learning-survey.md` from training knowledge. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, Meek rules R1-R3, faithfulness), [[PC Algorithm]] (3-phase algorithm, skeleton discovery, PC-stable, CI test table, 4-node worked example), [[Greedy Equivalence Search]] (FES/BES phases, score equivalence, Meek conjecture, BIC formula, FGS, R/Python code), [[Causal Discovery Algorithms - Comparison]] (full property table, unified consistency theorem, empirical benchmarks, decision guide, LiNGAM/FCI beyond-MEC table). Updated `_Index.md` (5→10 notes), `DAG Structure Learning Problem.md`, and `NOTEARS Experiments.md` with cross-links. |
