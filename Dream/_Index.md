...
**Covered by (2026-08-16):** [[Vine Copulas - Overview]], [[Pair Copula Constructions and Vine Structure]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`). Source survey: [[raw/Vine-Copulas-Survey-Aas2009-BedfordCooke-Czado]]. Note: source PDFs (Aas et al. 2009; Oh & Patton 2017) are freely available but network egress policy blocked download; a comprehensive markdown survey note was created instead following the vault's established pattern.
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Constructions and Vine Structure]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] | 2026-08-16 |
...
| 2026-08-16 | Gap #8 (Factor Copulas & Vine Copulas) marked 🍂 covered. Searched for free PDFs of Aas et al. (2009) (mistis.inrialpes.fr), Oh & Patton (2017) (Duke homepage), and Czado (2019) — all freely available but blocked by session network egress policy. Created synthesis survey `raw/Vine-Copulas-Survey-Aas2009-BedfordCooke-Czado.md` covering Bedford & Cooke (2002), Aas et al. (2009), and Czado (2019). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC definition, C-vine/D-vine/R-vine, simplifying assumption, trivariate examples), [[Pair Copula Constructions and Vine Structure]] (h-function with closed-form table, C-vine and D-vine density formulas with $d=4$ explicit expansions), [[Vine Copula Estimation and Model Selection]] (sequential MLE algorithm, Dissmann structure selection, copula family library with tail-dependence table, truncated vines, VineCopula/rvinecopulib software), [[Copula Architecture Comparison]] (head-to-head table across elliptical/Archimedean/vine/factor, practical decision flowchart). Updated `Dependence Modeling/_Index.md` (6→11 notes). |
