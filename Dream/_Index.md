...
**Covered by (2026-08-06):** [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula vs Factor Copula]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-06). Sources: Bedford & Cooke (2001/2002), Aas, Czado, Frigessi & Bakken (2009), Dißmann et al. (2013); PDF downloads blocked by session network policy — notes written from training knowledge synthesis.
...
| Factor/Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula vs Factor Copula]] | 2026-08-06 |
...
| 2026-08-06 | Run 18: Gap #8 (Factor/Vine Copulas) marked 🍂 covered. PDF downloads blocked by session network policy (403 on all external academic hosts — epub.ub.uni-muenchen.de, filelist.tudelft.nl, mediatum.ub.tum.de, arxiv.org all blocked). Created synthesis survey `raw/Vine-Copulas-Aas-Czado-Survey.md` from training knowledge of Bedford & Cooke (2001/2002), Aas, Czado, Frigessi & Bakken (2009), Joe (1996), and Dißmann et al. (2013). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC factorization, R-vine definition, simplifying assumption), [[Pair-Copula Construction]] (h-function with closed forms for 4 families, sequential IFM algorithm, tree-selection via Dißmann), [[C-Vine and D-Vine Structures]] (star-tree vs path-tree, n=4 worked examples, truncated vines), [[Vine Copula vs Factor Copula]] (architecture comparison table, when-to-prefer guidelines, n=100 equity worked example). Updated Dependence Modeling _Index.md (6→10 notes). |
