...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES Algorithm]], [[Causal Discovery Algorithm Comparison]] (all in `Causal Discovery/`, created 2026-08-29)
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES Algorithm]], [[Causal Discovery Algorithm Comparison]] | 2026-08-29 |
...
| 2026-08-29 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Targeted the 🌿 still relevant gap: NOTEARS was covered but PC algorithm (constraint-based, conditional independence testing) and GES (Greedy Equivalence Search, score-based) were entirely absent. Network egress policy blocked all academic PDF downloads (arXiv, JMLR, university servers) — created citation stub files in `Causal Discovery/raw/` with full references and download instructions for Chickering (2002) JMLR and Spirtes et al. (2000) MIT Press. Wrote 4 new notes from training knowledge of the papers: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, Meek R1–R4 rules, identifiability limits), [[PC Algorithm]] (CMC/faithfulness/causal-sufficiency assumptions, skeleton algorithm full pseudocode, v-structure orientation, consistency theorem, CI test table, pcalg/causal-learn code), [[GES Algorithm]] (decomposable BIC score, insert/delete operators, FES/BES phases with pseudocode, Meek conjecture proof, local score delta formula, pcalg/causal-learn code), [[Causal Discovery Algorithm Comparison]] (15-dimension comparison table, decision guide, failure mode analysis, connection to ABM structural learning and BN elicitation). Updated `Causal Discovery/_Index.md` (5→9 notes, new routing summary). |
