...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-29)
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] | 2026-07-29 |
...
| 2026-07-29 | Run 17: Addressed gap #8 (Factor Copulas and High-Dimensional Copula Architectures — vine/pair copula sub-gap). Searched arXiv, MDPI, LMU Munich epub, TU Delft, EconStor for Aas et al. (2009), Bedford & Cooke (2002), Czado (2010), Dißmann et al. (2013), Aas (2016) — all freely available but blocked by session network policy (proxy 403). Created synthesis survey `raw/Vine-Copulas-Synthesis-Survey.md` from training knowledge. Created 5 notes: [[Vine Copulas - Overview]] (motivation, Sklar decomposition, C/D/R-vine definitions, d=4 example), [[Pair-Copula Construction]] (h-function definition and table for 4 families, conditional CDF recursion, simplifying assumption, d=3 density formula, d=4 sequential example, sampling algorithm), [[C-Vine and D-Vine Structures]] (C-vine star topology d=4 example, D-vine path topology d=4 example, R-vine matrix representation, software table), [[Vine Copula Estimation and Selection]] (PIT preprocessing, Dißmann max-spanning-tree algorithm, AIC family selection, sequential MLE consistency, truncated vine, VineCopula R + pyvinecopulib Python code), [[Copula Architecture Comparison]] (4-architecture taxonomy, factor-vs-vine head-to-head table, practitioner decision guide, S&P 100 and d=10 commodity examples). Updated Dependence Modeling _Index.md (6→11 notes). Gap #8 now 🍂 covered. |
