...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-09-14). Also updated [[DAG Structure Learning Problem]] to add wikilinks in the prior-methods landscape table.
...
| Causal Structure Learning — PC + GES (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-09-14 |
...
| 2026-09-14 | Gap #9 (Causal Structure Learning — PC + GES) marked 🍂 covered. The 🌿 still-relevant portion (constraint-based PC algorithm and score-based GES) was addressed. arXiv and jmlr.org PDFs (Spirtes et al. 2000, Chickering 2002, Colombo & Maathuis 2014) found via WebSearch but blocked by session network policy; notes synthesised from training knowledge and web-search content. Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, faithfulness, causal sufficiency, CPDAG definition, 3-node examples), [[PC Algorithm]] (3-phase algorithm — skeleton recovery, v-structure identification, Meek rules — with pseudocode, CI test table, PC-stable variant, complexity analysis, correctness theorem), [[GES - Greedy Equivalence Search]] (FES + BES phases with pseudocode, BIC score decomposition, Meek Conjecture / Theorem 15, GES consistency, FGS fast implementation, PC vs GES comparison table). Updated [[DAG Structure Learning Problem]] landscape table to add wikilinks to [[PC Algorithm]] and [[GES - Greedy Equivalence Search]]. Updated `Causal Discovery/_Index.md` (5 → 8 notes). |
