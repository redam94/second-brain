...
**Covered by:** [[CPDAG and Markov Equivalence]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-04)
...
| Causal Structure Learning (#9) | [[CPDAG and Markov Equivalence]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-08-04 |
...
| 2026-08-04 | Gap #9 (Causal Structure Learning) marked 🍂 covered. Source PDFs (Chickering 2002 JMLR, Kalisch & Bühlmann 2007 arXiv, SGS 2000) blocked by egress policy; notes written from training knowledge following Gap #1 precedent. Created synthesis survey `raw/PC-GES-structure-learning-survey.md`. Created 3 notes in `Causal Discovery/`: [[CPDAG and Markov Equivalence]] (d-separation, Markov equivalence theorem, CPDAG definition, faithfulness, all four Meek rules R1–R4), [[PC Algorithm]] (three phases: skeleton recovery via CI tests, v-structure orientation, Meek propagation; consistency theorem SGS 2000; high-dimensional consistency Kalisch & Bühlmann 2007; PC-stable; CI test table; R pcalg code; failure modes), [[GES - Greedy Equivalence Search]] (Meek Conjecture / Chickering Theorem 15; decomposable + consistent score; FES edge insertions; BES edge deletions; GES consistency theorem; BGe score; fGES; GES vs PC comparison table; R ges + Python ges code). Updated `Causal Discovery/_Index.md` (5→8 notes, expanded routing, method comparison table). |
