...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-09-20)
...
| Causal Structure Learning: PC & GES (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]] | 2026-09-20 |
...
| 2026-09-20 | Gap #9 (Causal Structure Learning: PC algorithm & GES) marked 🍂 covered. PDF downloads for Kalisch & Bühlmann (2007, arXiv:math/0510436) and Chickering (2002, JMLR v3) were blocked by session egress proxy policy (arxiv.org and jmlr.org denied). Created synthesis notes from training knowledge of both papers. Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma–Pearl characterisation, CPDAG definition, faithfulness, Meek rules R1–R4, identifiability table), [[PC Algorithm]] (constraint-based; assumptions, skeleton discovery algorithm, separating sets, v-structure orientation, CI test types, Kalisch-Bühlmann consistency theorem, PC-stable, FCI, software), [[Greedy Equivalence Search]] (score-based; score requirements, BIC/BDe/BGe examples, Meek Conjecture proof Chickering Thm.15, FES+BES+turning phase, GES consistency theorem, PC vs GES comparison table, FGES, software). Created text stubs `raw/chickering2002-ges.txt` and `raw/kalisch2007-pc-algorithm.txt` recording the blocked URLs. Updated `Causal Discovery/_Index.md` (5→8 notes). Updated `depends_on`/`used_by` in [[DAG Structure Learning Problem]]. |
