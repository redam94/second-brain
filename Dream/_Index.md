...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[Constraint-Based Causal Discovery]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]] (all in `Causal Discovery/`, added 2026-09-07). Together with existing NOTEARS notes, the full landscape — constraint-based (PC/PC-stable), score-based greedy (GES), and continuous-optimization (NOTEARS) — is now covered.
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence Classes and CPDAGs]], [[Constraint-Based Causal Discovery]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]] | 2026-09-07 |
...
| 2026-09-07 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. External PDF downloads blocked by session network egress policy (arXiv, JMLR both 403). Created source-reference stubs `raw/chickering02b-GES-source.md` (Chickering 2002, JMLR) and `raw/colombo2014-PC-stable-source.md` (Colombo & Maathuis 2014, JMLR / arXiv:1211.3295) with full citations and BibTeX. Wrote 4 new notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Verma-Pearl MEC theorem, CPDAG definition, Meek R1–R4 rules, identifiability limits of observational data), [[Constraint-Based Causal Discovery]] (Fisher z-test CI, skeleton-learning algorithm, PC-stable order-independence fix, consistency theorem, PC vs GES comparison table), [[PC Algorithm]] (full PC-stable pseudocode Algorithm 1, v-structure orientation logic, four-variable worked example, software notes), [[Greedy Equivalence Search (GES)]] (BIC score-equivalence, Insert/Delete/Turn operators, three-phase GES pseudocode, Meek Conjecture proof sketch, GES consistency theorem, PC vs GES table). Updated `Causal Discovery/_Index.md` (5→9 notes). Together with the existing NOTEARS cluster, the full structure-learning landscape is now covered. |
