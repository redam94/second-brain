...
**Covered by (2026-08-17):**
- [[Markov Equivalence Classes and CPDAGs]] — Verma-Pearl theorem, CPDAG definition, I-maps
- [[PC Algorithm - Overview]] — assumptions, three phases, complexity, FCI extension
- [[Constraint-Based Skeleton Learning]] — Phase 1: CI tests at increasing order, PC-stable, high-dim consistency
- [[V-Structures and Meek Orientation Rules]] — Phases 2–3: v-structure identification, Meek R1–R4
- [[GES - Greedy Equivalence Search]] — FES + BES algorithm, Meek Conjecture/Theorem 15, consistency
- [[Causal Discovery Algorithm Comparison]] — PC vs GES vs NOTEARS: assumptions, output, complexity, practical guidance

All 6 notes in `Causal Discovery/`. Source PDFs (Spirtes et al. 2000 CPS book, Chickering 2002 JMLR) were blocked by network egress policy on 2026-08-17; synthesized reference documents created in `raw/`.
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[Constraint-Based Skeleton Learning]], [[V-Structures and Meek Orientation Rules]], [[GES - Greedy Equivalence Search]], [[Causal Discovery Algorithm Comparison]] | 2026-08-17 |
...
| 2026-08-17 | Run 10 (scheduled): Gap #9 (Causal Structure Learning from Data) covered. Network egress blocked arxiv.org, jmlr.org, and all standard academic PDF hosts — synthesized reference documents created in `Causal Discovery/raw/` from canonical knowledge of the algorithms. Created 6 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, I-maps), [[PC Algorithm - Overview]] (Spirtes & Glymour 1991; SGS 2000 — three assumptions, three phases, complexity), [[Constraint-Based Skeleton Learning]] (Phase 1 adjacency search, CI tests, PC-stable, high-dim consistency), [[V-Structures and Meek Orientation Rules]] (Phases 2–3, Meek R1–R4 completeness theorem), [[GES - Greedy Equivalence Search]] (Chickering 2002 — FES + BES operators, Meek Conjecture/Theorem 15, consistency), [[Causal Discovery Algorithm Comparison]] (PC vs GES vs NOTEARS: assumptions, output, complexity, when-to-use). Updated `Causal Discovery/_Index.md` with new cluster. |
