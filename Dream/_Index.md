...
**Covered by:** [[Propensity Score Matching - Overview]], [[Propensity Score and the Balancing Property]], [[Matching Methods and Distance Measures]], [[Covariate Balance Diagnostics]], [[Common Support and Overlap]] (all in `Econometrics/Identification Strategies/Propensity Score Matching/`, ingested 2026-06-28 from Stuart 2010); plus synthesis notes [[Matching Algorithms and Caliper]] and [[Covariate Balance and Matching Diagnostics]] in `Econometrics/Identification Strategies/`
...
**Covered by:** [[Q- and A-learning - Overview]], [[Dynamic Treatment Regimes Framework]], [[Optimal Regime via Dynamic Programming]], [[Q-learning]], [[A-learning and Robustness]] (all in `Bayesian Statistics/Causal Inference/Dynamic Treatment Regimes/`; already present — status corrected 2026-09-18)
...
**Covered by:** [[Variational Inference - Overview]], [[The ELBO and KL Divergence Minimization]], [[Mean-Field Family and Coordinate Ascent VI (CAVI)]], [[Stochastic and Black-Box Variational Inference]], [[Automatic Differentiation Variational Inference (ADVI)]], [[Reparameterization Trick and Variational Autoencoders]], [[Normalizing Flows for Variational Inference]], [[Diagnosing Variational Inference (PSIS k-hat and VSBC)]] (all in `Bayesian Statistics/Computation/Variational Inference/`, ingested 2026-09-18 from Blei 2017, Ranganath 2014, Kucukelbir 2017, Kingma & Welling 2013, Rezende & Mohamed 2015, Yao 2018)
...
**Covered by:** [[Causal Machine Learning - Overview]], [[Regularization Bias and the Partially Linear Model]], [[Neyman Orthogonality]], [[Cross-Fitting and Sample Splitting]], [[DML Estimators for ATE and the Interactive Model]], [[R-Learner and Orthogonal CATE Estimation]] (all in `Econometrics/Causal Machine Learning/`, ingested 2026-09-18 from Chernozhukov et al. 2018 and Nie & Wager 2021)
...
**Covered by:** [[Event Study Designs and Dynamic Treatment Effects]], [[Pre-Trend Testing and Its Pitfalls]], [[Honest DiD - Sensitivity to Parallel Trends Violations]] (in `Econometrics/Identification Strategies/Synthetic Difference-in-Differences/`, ingested 2026-09-18 from Roth 2022, Rambachan & Roth 2023, Roth et al. 2023)
...
**Covered by:** [[Honest Trees and Causal Forests]], [[Generalized Random Forests - Local Moment Equations]], [[Asymptotic Normality and Inference for Forests]] (in `Econometrics/Causal Machine Learning/`, ingested 2026-09-18 from Wager & Athey 2018 and Athey, Tibshirani & Wager 2019)
...
**Covered by:** [[Synthetic Difference-in-Differences - Overview]], [[SDID Estimator - Unit and Time Weights]], [[SDID vs DiD vs Synthetic Control]], [[SDID Inference - Bootstrap, Jackknife and Placebo]], [[SDID for Geo Experiments and Marketing Panels]] (in `Econometrics/Identification Strategies/Synthetic Difference-in-Differences/`, ingested 2026-09-18 from Arkhangelsky et al. 2021)
...
## AI-Era and Applied Gaps

> [!note] Added 2026-09-18
> The first 57 gaps were all found by following links *out of* existing notes, so they stay inside classical statistics and econometrics. A top-down audit on 2026-09-18 showed the vault had **no machine-learning / AI coverage at all** and lacked several applied-statistics use cases central to marketing measurement. Eleven clusters were ingested that day (see Log); the gaps below are what that run surfaced but did not cover.

### 58. Reinforcement Learning and Off-Policy Evaluation
**Status:** 🌱 new

**Why it's a gap:**
The vault has bandits ([[Multi-Armed Bandits and Thompson Sampling - Overview]], [[Contextual and Linear Bandits]]), dynamic treatment regimes ([[Q-learning]], [[Optimal Regime via Dynamic Programming]]) and now [[RLHF and Instruction Tuning]] — three places that use RL machinery with no note on RL itself (MDPs, policy gradients, PPO) or on off-policy evaluation (IPS, doubly-robust OPE), which is the bridge from logged marketing data to policy value and is structurally identical to [[DML Estimators for ATE and the Interactive Model]].

**Adjacent notes:** [[Contextual and Linear Bandits]], [[Q-learning]], [[RLHF and Instruction Tuning]], [[DML Estimators for ATE and the Interactive Model]], [[Decision Analysis]]

**Suggested sources / search terms:**
- Dudík, Langford & Li (2011) — "Doubly Robust Policy Evaluation and Learning" (arXiv 1103.4601)
- Levine, Kumar, Tucker & Fu (2020) — "Offline Reinforcement Learning: Tutorial, Review, and Perspectives" (arXiv 2005.01643)
- Schulman et al. (2017) — "Proximal Policy Optimization Algorithms" (arXiv 1707.06347)
- Athey & Wager (2021) — "Policy Learning with Observational Data" (arXiv 1702.02896)

---

### 59. Uplift Modeling and Policy Learning from CATEs
**Status:** 🌱 new

**Why it's a gap:**
[[Metalearners for CATE]], [[Honest Trees and Causal Forests]] and [[R-Learner and Orthogonal CATE Estimation]] estimate heterogeneous effects, but nothing covers how marketers *use and evaluate* them: uplift/Qini curves, AUUC, targeting policies under budget constraints, and policy-value inference.

**Adjacent notes:** [[Metalearners for CATE]], [[R-Learner and Orthogonal CATE Estimation]], [[Honest Trees and Causal Forests]], [[ROAS, mROAS, and Optimal Media Mix]], [[Customer Lifetime Value - Overview]]
...
### 60. Multi-Touch Attribution and Shapley-Value Methods
**Status:** 🌱 new

**Why it's a gap:**
The vault covers aggregate attribution (MMM) and experiments (geo, A/B) but not user-path attribution: last-touch vs data-driven attribution, Shapley values, Markov-chain removal effects, and why these are descriptive rather than causal ([[Activity Bias in Advertising]]). The same Shapley machinery underlies ML interpretability (gap #61).

**Adjacent notes:** [[Activity Bias in Advertising]], [[Observational vs Experimental Methods in Advertising]], [[Bayesian Media Mix Modeling - Overview]], [[Delayed Feedback Model for Conversion Prediction]]

**Suggested sources / search terms:**
- Dalessandro, Perlich, Stitelman & Provost (2012) — "Causally motivated attribution for online advertising"
- Shao & Li (2011) — "Data-driven multi-touch attribution models" (KDD)
- Singal et al. (2019) — "Shapley Meets Uniform: An Axiomatic Framework for Attribution in Online Advertising" (arXiv 1902.05927)

---

### 61. ML Interpretability (SHAP, Partial Dependence, Feature Attribution)
**Status:** 🌱 new

**Why it's a gap:**
With ML models now in the vault (forests, DeepAR, transformers), there is no note on explaining them, nor on the key caveat that feature attributions are not causal effects ([[Table 2 Fallacy]], [[Logic of Regression Adjustment]]).

**Adjacent notes:** [[Table 2 Fallacy]], [[Logic of Regression Adjustment]], [[Generalized Random Forests - Local Moment Equations]], [[Variance-Based Sensitivity and Sobol Indices]]

**Suggested sources / search terms:**
- Lundberg & Lee (2017) — "A Unified Approach to Interpreting Model Predictions" (arXiv 1705.07874)
- Molnar — *Interpretable Machine Learning* (open book)
- Owen & Prieur (2017) — "On Shapley value for measuring importance of dependent inputs" (links SHAP to Sobol indices)

---

### 62. Bayesian Deep Learning and Neural-Network Uncertainty
**Status:** 🌱 new

**Why it's a gap:**
[[Reparameterization Trick and Variational Autoencoders]] and [[Conformal Prediction - Overview]] give two routes to uncertainty for neural models; the Bayesian route (BNN priors, MC-dropout, deep ensembles, Laplace approximations, the cold-posterior effect) is missing, as is LLM calibration.

**Adjacent notes:** [[Variational Inference - Overview]], [[Gaussian Process Regression]], [[Conformal Prediction - Overview]], [[Approximation Methods]]

**Suggested sources / search terms:**
- Wilson & Izmailov (2020) — "Bayesian Deep Learning and a Probabilistic Perspective of Generalization" (arXiv 2002.08791)
- Lakshminarayanan, Pritzel & Blundell (2017) — "Simple and Scalable Predictive Uncertainty Estimation using Deep Ensembles" (arXiv 1612.01474)
- Daxberger et al. (2021) — "Laplace Redux" (arXiv 2106.14806)

---

### 63. Prior-Fitted Networks and Transformers for Tabular / Time-Series Data
**Status:** 🌱 new

**Why it's a gap:**
[[In-Context Learning and Few-Shot Prompting]] reads ICL as amortized Bayesian inference and [[Time-Series Foundation Models (Chronos)]] covers one zero-shot forecaster, but TabPFN-style prior-fitted networks — transformers trained on draws from a prior to output posterior predictives — are the most direct AI-meets-Bayes idea and are not covered; nor are covariate-aware neural forecasters (TFT, N-BEATS, PatchTST, TimesFM, Moirai) that an MMM practitioner would actually need.

**Adjacent notes:** [[In-Context Learning and Few-Shot Prompting]], [[Time-Series Foundation Models (Chronos)]], [[Neural Posterior Estimation (NPE)]], [[DeepAR and Global Autoregressive Neural Forecasters]]
...
### 64. Conformal Prediction Beyond Exchangeability (Time Series, Jackknife+, Risk Control)
**Status:** 🌱 new

**Why it's a gap:**
[[Split Conformal Prediction and the Coverage Guarantee]] needs exchangeability, which every forecasting and MMM application violates. Adaptive conformal inference, jackknife+/CV+ and conformal risk control are the missing pieces for using conformal intervals on [[Forecast Evaluation and Backtesting]]-style problems.

**Adjacent notes:** [[Conformal Prediction Under Covariate Shift]], [[Marginal vs Conditional Coverage]], [[Forecast Evaluation and Backtesting]], [[Counterfactual Impact Estimation]]

**Suggested sources / search terms:**
- Gibbs & Candès (2021) — "Adaptive Conformal Inference Under Distribution Shift" (arXiv 2106.00170)
- Barber, Candès, Ramdas & Tibshirani (2021) — "Predictive inference with the jackknife+" (arXiv 1905.02928); (2022) "Conformal prediction beyond exchangeability" (arXiv 2202.13415)
- Angelopoulos et al. (2022) — "Conformal Risk Control" (arXiv 2208.02814)

---

### 65. Post-Training and Test-Time Reasoning for LLMs (DPO, Self-Consistency, LLM-as-Judge)
**Status:** 🌱 new

**Why it's a gap:**
[[RLHF and Instruction Tuning]] and [[Chain-of-Thought Prompting]] stop at 2022. Direct preference optimisation, reward over-optimisation scaling, self-consistency / tree-of-thoughts, reasoning-model training, LLM-as-judge validity, and embedding / dense-retrieval models (BERT, DPR) behind [[Retrieval-Augmented Generation (RAG)]] are not covered.

**Adjacent notes:** [[RLHF and Instruction Tuning]], [[Reward Modeling from Human Preferences]], [[Chain-of-Thought Prompting]], [[Evaluating LLM Systems - Benchmarks, Hallucination and Human Preference]], [[Retrieval-Augmented Generation (RAG)]]
...
- Devlin et al. (2018) — BERT (arXiv 1810.04805); Karpukhin et al. (2020) — DPR (arXiv 2004.04906)

---

### 66. LLMs for Market Research: Synthetic Conjoint, Prediction-Powered Inference, MRP
**Status:** 🌱 new

**Why it's a gap:**
[[Silicon Samples and Algorithmic Fidelity]] and [[Validity, Bias and Calibration of LLM-Simulated Populations]] establish the idea and the threats; the practical toolkit is missing — LLM-based conjoint / willingness-to-pay studies, prediction-powered inference for combining a small human sample with a large synthetic one, and a dedicated MRP note beyond [[Poststratification]]. Classical conjoint / hierarchical-Bayes choice models are also absent (see gap #16).

**Adjacent notes:** [[Silicon Samples and Algorithmic Fidelity]], [[Persona Mixture Calibration of LLM Agents]], [[Poststratification]], [[Discrete Choice Models]], [[Random Coefficients Logit Model]]

**Suggested sources / search terms:**
- Brand, Israeli & Ngwe (2023) — "Using LLMs for Market Research" (HBS working paper)
...
### 67. Advanced Online Experimentation: Long-Term Effects, e-Values, Network Interference
**Status:** 🌱 new

**Why it's a gap:**
[[Online Experimentation - Overview]] covers the core stack. Still missing: surrogate indices and novelty decay for long-term effects, group-sequential alpha-spending and e-values / game-theoretic testing (the theory behind [[Confidence Sequences]]), inference after adaptive bandit allocation, exposure-mapping estimators for network interference, and the delta method for ratio metrics.

**Adjacent notes:** [[Confidence Sequences]], [[Always-Valid p-values and the mSPRT]], [[Interference and Marketplace Experiments]], [[Approximate Thompson Sampling and Practical Extensions]], [[Carryover Effects and Distributed Lags]]

**Suggested sources / search terms:**
- Athey, Chetty, Imbens & Kang (2019) — "The Surrogate Index" (NBER 26463)
- Ramdas, Grünwald, Vovk & Shafer (2023) — "Game-Theoretic Statistics and Safe Anytime-Valid Inference" (arXiv 2210.01948)
- Hadad et al. (2021) — "Confidence intervals for policy evaluation in adaptive experiments" (arXiv 1911.02768)
- Aronow & Samii (2017) — "Estimating average causal effects under general interference"

---

### 68. Modern Panel Causal Methods: Augmented SC, Matrix Completion, Imputation DiD
**Status:** 🌱 new

**Why it's a gap:**
[[SDID vs DiD vs Synthetic Control]] places three estimators in one family; the neighbours are missing — augmented synthetic control, matrix-completion estimators, Sun–Abraham / Borusyak–Jaravel–Spiess imputation estimators, Goodman-Bacon decomposition, and Conley–Taber inference with few treated units (the usual geo-test situation).

**Adjacent notes:** [[SDID vs DiD vs Synthetic Control]], [[Synthetic Control Extensions]], [[Generalized Synthetic Control Method]], [[Group-Time Average Treatment Effects]], [[Event Study Designs and Dynamic Treatment Effects]]

**Suggested sources / search terms:**
- Ben-Michael, Feller & Rothstein (2021) — "The Augmented Synthetic Control Method" (arXiv 1811.04170)
- Athey et al. (2021) — "Matrix Completion Methods for Causal Panel Data Models" (arXiv 1710.10251)
- Borusyak, Jaravel & Spiess (2024) — "Revisiting Event Study Designs" (arXiv 2108.12419)
- Goodman-Bacon (2021) — "Difference-in-differences with variation in treatment timing"

---

### 69. Customer-Base Valuation and Extended Buy-Till-You-Die Models
**Status:** 🌱 new

**Why it's a gap:**
[[Customer Lifetime Value - Overview]] covers the core Fader–Hardie models. Missing: BG/BB for discrete-time settings, duration-dependence models (beta-discrete-Weibull), individual-level hierarchical-Bayes Pareto-NBD with time-varying covariates (Abe 2009), and customer-equity / firm-valuation applications. Dream gaps #16 (latent class segmentation) and #22 (Bass diffusion) remain the adjacent open marketing-science gaps.

**Adjacent notes:** [[Pareto-NBD Model]], [[BG-NBD Model]], [[Bayesian and Hierarchical Extensions of CLV Models]], [[Shifted-Beta-Geometric Model for Contractual Retention]]

**Suggested sources / search terms:**
- Fader, Hardie & Shang (2010) — "Customer-Base Analysis in a Discrete-Time Noncontractual Setting" (BG/BB)
- Abe (2009) — "Counting Your Customers One by One: A Hierarchical Bayes Extension to the Pareto/NBD Model"
- McCarthy & Fader (2018) — "Customer-Based Corporate Valuation for Publicly Traded Noncontractual Firms"

---

### 70. Frontier Neural SBI and VI: Misspecification, Expectation Propagation, Pathfinder
**Status:** 🌱 new

**Why it's a gap:**
[[Neural Simulation-Based Inference - Overview]] and [[Variational Inference - Overview]] leave open: robustness of neural SBI to simulator misspecification (the normal case for ABMs), SNPE-C/APT and contrastive NRE as primary sources, differentiable / gray-box ABMs, expectation propagation and Rényi-divergence VI, linear-response covariance corrections, importance-weighted autoencoders, and a primary-source note for Pathfinder.

**Adjacent notes:** [[Neural SBI for Agent-Based and Economic Models]], [[Benchmarking and Diagnosing SBI (SBC, Coverage, C2ST)]], [[Diagnosing Variational Inference (PSIS k-hat and VSBC)]], [[Variational Inference and Pathfinder]], [[ABM Validation Challenges]]

**Suggested sources / search terms:**
- Cannon et al. (2022) — "Investigating the Impact of Model Misspecification in Neural Simulation-based Inference" (arXiv 2209.01845)
...
| Dynamic Treatment Regimes (#18) | [[Q- and A-learning - Overview]], [[Dynamic Treatment Regimes Framework]] + 3 more | 2026-09-18 |
| Variational Inference (#33) | [[Variational Inference - Overview]], [[The ELBO and KL Divergence Minimization]] + 6 more | 2026-09-18 |
| Double/Debiased ML & Neyman Orthogonality (#40) | [[Causal Machine Learning - Overview]], [[Regularization Bias and the Partially Linear Model]] + 4 more | 2026-09-18 |
| Event Study Designs & Pre-Trend Testing (#45) | [[Event Study Designs and Dynamic Treatment Effects]], [[Pre-Trend Testing and Its Pitfalls]] + 1 more | 2026-09-18 |
| Causal Forests & GRF (#46) | [[Honest Trees and Causal Forests]], [[Generalized Random Forests - Local Moment Equations]] + 1 more | 2026-09-18 |
| Synthetic Difference-in-Differences (#47) | [[Synthetic Difference-in-Differences - Overview]], [[SDID Estimator - Unit and Time Weights]] + 4 more | 2026-09-18 |
