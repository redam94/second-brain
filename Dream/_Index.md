...
> - Need to find an open gap? → See **Suggested Topics** below (status: 🌱 new, 🔄 in-progress, 🍂 covered)
> - Need the run log? → See **Run Log** at the bottom
> - Need to add a gap? → Append a new numbered entry under **Suggested Topics**
...
**Adjacent notes:** [[Bayesian Propensity Score Weighting]], [[Frequentist Causal Estimation]], [[Conditional Independence Assumption]], [[The Selection Problem]], [[Omitted Variables Bias]], [[Activity Bias in Advertising]]
