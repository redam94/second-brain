...
**Covered by:** [[Causal Discovery Landscape]], [[Constraint-Based Causal Discovery]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-09)
...
| Causal Structure Learning (#9) | [[Causal Discovery Landscape]], [[Constraint-Based Causal Discovery]], [[GES - Greedy Equivalence Search]] | 2026-08-09 |
...
| 2026-08-09 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Network policy blocked all academic repositories (arXiv, JMLR, SSRN, university repos) — pivoted to GitHub-hosted sources on `raw.githubusercontent.com`. Downloaded 2 raw files into `Research/Causal Discovery/raw/`: `ges-algorithm-juangamella-README.md` (juangamella/ges, GES algorithm and Chickering 2002) and `causal-learn-README.md` (py-why/causal-learn, PC + GES + landscape overview). Created 3 notes in `Research/Causal Discovery/`: [[Causal Discovery Landscape]] (three-paradigm comparison table, identifiability triple, CPDAG definition, software ecosystem), [[Constraint-Based Causal Discovery]] (PC algorithm: skeleton phase PC-1, v-structure detection PC-2, Meek orientation rules R1–R4, consistency theorem, CI test selection table, 4-variable worked example), [[GES - Greedy Equivalence Search]] (score-equivalent/locally-decomposable score, Gaussian BIC, Insert/Delete/Turn operators, forward/backward/turning phase algorithms, consistency theorem, Python usage, 2 worked examples). Updated `_Index.md` (concept_count 5→8, routing summary, concept map, CONTAINS annotations, sources, see also), `DAG Structure Learning Problem.md` (used_by extended to 5 entries), `NOTEARS Experiments.md` (used_by extended to 2 entries). |
