...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Constraint vs Score-Based Causal Discovery]] (all in `Causal Discovery/`, created 2026-07-21)
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Constraint vs Score-Based Causal Discovery]] | 2026-07-21 |
...
| 2026-07-21 | Run 16: Gap #9 (Causal Structure Learning — constraint-based and score-based methods) marked 🍂 covered. Searched arXiv, JMLR, and CMU for Spirtes et al. (2000) and Chickering (2002) — freely available but blocked by session network policy. Created synthesis survey `raw/PC-GES-Causal-Discovery-Survey.md` from training knowledge. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, Meek rules R1–R4, covered edge reversals), [[PC Algorithm]] (skeleton phase, v-structure orientation, PC-stable, Fisher z-test, FCI extension, two worked examples), [[Greedy Equivalence Search]] (FES + BES phases, decomposable scores, Meek Conjecture proof, validity conditions, FGES/GIES/BOSS variants), [[Constraint vs Score-Based Causal Discovery]] (comparison table, decision guide, software ecosystem). Updated `Causal Discovery/_Index.md` (5→9 notes). Cross-linked into [[DAG Structure Learning Problem]] and [[NOTEARS Experiments]]. |
