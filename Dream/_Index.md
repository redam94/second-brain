...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES Algorithm]] (all in `Causal Discovery/`, created 2026-07-27)
...
| Causal Structure Learning (#9) — PC and GES | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES Algorithm]] | 2026-07-27 |
...
| 2026-07-27 | Gap #9 (Causal Structure Learning from Data — PC and GES) marked 🍂 covered. External PDF downloads blocked by session network proxy (arXiv, JMLR unreachable). Created synthesis survey `raw/PC-GES-Structure-Learning-Survey.md` from training knowledge of Spirtes/Glymour/Scheines (2000), Chickering (2002 JMLR), Colombo & Maathuis (2014 JMLR), Verma & Pearl (1990), Meek (1995). Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma & Pearl skeleton+v-structure theorem, CPDAG definition, Meek's 4 rules, covered edges, three-node example), [[PC Algorithm]] (faithfulness def, PC pseudocode Phases 0–3, consistency theorem, $O(d^{\Delta+2})$ complexity, stable PC Colombo & Maathuis 2014, Fisher's Z CI test, failure modes table), [[GES Algorithm]] (decomposable score, BIC, GES-I Insert phase with clique set, GES-II Delete phase with cut set, Chickering 2002 main theorem + key lemmas, FGS definition, two worked examples, PC/GES/NOTEARS comparison). Updated `Causal Discovery/_Index.md` (5→8 notes, new concept map rows, updated routing summary and sources). |
