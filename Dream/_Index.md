...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]], [[Constraint-Based vs Score-Based Causal Discovery]] (all in `Causal Discovery/`, created 2026-08-14). Source: `raw/chickering2016-selective-GES.pdf` (Chickering & Meek 2016, Selective GES). Full CPDAG theory, PC algorithm three-phase walkthrough, GES FES+BES with consistency theorem, paradigm comparison table. Combined with the prior NOTEARS cluster (5 notes), the Causal Discovery folder now covers all three paradigms.

**Partially addressed (2026-06-22):** The `Causal Discovery/` subfolder covers NOTEARS comprehensively: [[NOTEARS - Overview]], [[DAG Structure Learning Problem]], [[Smooth Characterization of Acyclicity]], [[NOTEARS Algorithm]], [[NOTEARS Experiments]]. The score-based continuous-optimization approach is well-documented. Constraint-based methods (PC algorithm, conditional independence testing) and score-based search (GES / Greedy Equivalence Search) were absent until 2026-08-14.
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]], [[Constraint-Based vs Score-Based Causal Discovery]] | 2026-08-14 |
...
| 2026-08-14 | Run 19: addressed Gap #9 (Causal Structure Learning from Data). Downloaded `chickering2016-selective-GES.pdf` from Microsoft Research. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma & Pearl theorem, CPDAGs, compelled/reversible edges, IMAP order, covered edges), [[PC Algorithm]] (skeleton/v-structure/Meek orientation phases, faithfulness/Markov/causal sufficiency assumptions, PC-stable, FCI extension), [[GES - Greedy Equivalence Search]] (FES+BES operators, score requirements, Theorem 1 Chickering 2002, SGES polynomial variant, FGES), [[Constraint-Based vs Score-Based Causal Discovery]] (three-paradigm comparison table: PC vs GES vs NOTEARS, when-to-use guidance). Updated `Causal Discovery/_Index.md` (5→9 notes). Gap #9 marked 🍂 covered. |
