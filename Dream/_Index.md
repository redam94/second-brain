...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Causal Discovery]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-07-25)
...
| Causal Structure Learning / PC + GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Causal Discovery]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-07-25 |
...
| 2026-07-25 | Run 16: Gap #9 (Causal Structure Learning — PC algorithm and GES) marked 🍂 covered. Network policy blocked PDF downloads from JMLR and arXiv. Created two synthesis surveys in `Causal Discovery/raw/` from training knowledge: `survey-PC-algorithm-constraint-based-causal-discovery.md` (covering Spirtes et al. 2000, Spirtes 2010 JMLR, Meek 1995, Colombo & Maathuis 2014) and `survey-GES-chickering2002-greedy-equivalence-search.md` (covering Chickering 2002 JMLR, Ramsey et al. 2017 FGES). Created 4 notes: [[Markov Equivalence Classes and CPDAGs]] (Verma-Pearl theorem, CPDAG definition, Meek rules R1–R4), [[Conditional Independence Tests for Causal Discovery]] (Fisher $Z$, $G^2$, KCIT, $\alpha$ tuning), [[PC Algorithm]] (skeleton construction, v-structure orientation, consistency theorem, PC-stable, FCI), [[GES - Greedy Equivalence Search]] (FES/BES phases, BIC score, Theorem 15 / Meek conjecture, FGES). Updated `Causal Discovery/_Index.md` (5→9 notes). |
