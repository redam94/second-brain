...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Constructions and Vine Structures]], [[Vine Copula Estimation and Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-31)
...
| Factor/Vine Copulas / Copula Architectures (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Constructions and Vine Structures]], [[Vine Copula Estimation and Architecture Comparison]] | 2026-07-31 |
...
| 2026-07-31 | Run 17: addressed gap #8 (Vine/Pair-Copula Architectures). Searched for Aas et al. (2009), Bedford & Cooke (2002), Czado (2019) at arXiv, LMU Munich open-access repository, JMLR, CRAN — all freely available but blocked by session network policy (outbound connections to academic domains time out). Created synthesis survey `raw/Vine-Copulas-Synthesis-Survey.md` from training knowledge (following Run 12 precedent). Created 3 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (pair-copula construction concept, C/D/R-vine informal definitions, simplifying assumption, historical timeline, factor vs vine comparison), [[Pair-Copula Constructions and Vine Structures]] (Bedford & Cooke 2002 density theorem, h-function with closed-form table, d=4 C-vine and D-vine worked examples, parameter count table), [[Vine Copula Estimation and Architecture Comparison]] (Dißmann MST structure selection algorithm, sequential MLE, pair copula family selection table, truncated vines, R/Python code, systematic vine vs factor comparison table). Updated `Dependence Modeling/_Index.md` (6→9 notes). Gap #8 marked 🍂 covered. |
