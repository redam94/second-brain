...
**Covered by (2026-09-06):** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]], [[Causal Structure Learning - Comparison]] (all in `Causal Discovery/`, added 2026-09-06). Sources: Spirtes, Glymour & Scheines (2000) CPS Ch. 5; Chickering (2002) JMLR; Kalisch & Bühlmann (2007) JMLR. PDF downloads blocked by network egress policy; notes written from training knowledge of these well-documented classic algorithms.
...
| Causal Structure Learning — PC and GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]], [[Causal Structure Learning - Comparison]] | 2026-09-06 |
...
| 2026-09-06 | Run 22: addressed gap #9 (Causal Structure Learning — PC and GES). PDF downloads for Spirtes et al. (2000 CPS), Chickering (2002 JMLR), Kalisch & Bühlmann (2007 JMLR) blocked by network egress policy (arxiv.org and jmlr.org denied). Created 3 source stubs in `Causal Discovery/raw/`. Created 4 notes: [[Markov Equivalence Classes and CPDAGs]] (Markov equiv theorem — Verma & Pearl 1990, CPDAG definition, Meek rules R1–R4, identifiability limit, examples), [[PC Algorithm]] (3-phase skeleton/v-structure/Meek algorithm, separation sets, consistency theorem — Kalisch & Bühlmann 2007, complexity, Sachs example, decision guide), [[GES - Greedy Equivalence Search]] (BIC score decomposability, Insert/Delete CPDAG operators, 2-phase algorithm, Meek Conjecture proof — Chickering 2002, GES consistency, FGES extension, PC vs GES table), [[Causal Structure Learning - Comparison]] (identifiability limit, assumption comparison, full algorithm comparison, empirical benchmarks, ABM applications). Updated `Causal Discovery/_Index.md` (5→9 concept notes). Gap #9 marked 🍂 covered. |
