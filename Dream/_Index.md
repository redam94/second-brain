...
**Covered by:** [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Model Selection]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-04)
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Model Selection]] | 2026-07-04 |
...
| 2026-07-04 | Gap #8 (Vine Copulas / Factor Copulas Architecture Comparison) marked 🍂 covered. Factor copula part was already covered (6 notes in Dependence Modeling, 2026-06-22); vine/pair copulas remained absent. Searched for Aas et al. (2009) and Czado & Nagler (2022) free PDFs — all blocked by session network policy. Created synthesis survey `raw/Vine-Copula-Aas-Czado-Survey.md` from training knowledge covering Bedford & Cooke (2002), Aas et al. (2009), Czado & Nagler (2022), and Dissmann et al. (2013). Created 3 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (pair-copula decomposition, regular vine definition, h-function, simplifying assumption, factor vs vine vs Normal/t architecture comparison table), [[C-Vine and D-Vine Structures]] (star vs path topology, explicit 4-variable density formulas for both, h-function recursion, R-vine matrix), [[Vine Copula Estimation and Model Selection]] (sequential MLE 5-step algorithm, pair copula families, AIC/BIC selection, Dissmann MST algorithm, truncated vines, rvinecopulib R and pyvinecopulib Python code). Updated Dependence Modeling _Index.md (6→9 notes) and Econometrics _Index.md (51→54 notes). |
