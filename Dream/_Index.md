...
**Covered by:** [[Propensity Score Matching]], [[Matching Algorithms and Caliper Matching]], [[Covariate Balance Diagnostics]] (all in `Econometrics/Identification Strategies/`, added 2026-06-29)
...
| Propensity Score Matching / Balance Diagnostics (#1) | [[Propensity Score Matching]], [[Matching Algorithms and Caliper Matching]], [[Covariate Balance Diagnostics]] | 2026-06-29 |
...
| 2026-06-29 | Run 12: Gap #1 (Propensity Score Matching / Balance Diagnostics) addressed. Source searched: Imbens (2004) NBER W8442 and Rosenbaum & Rubin (1983) — both confirmed freely available but inaccessible from this environment (proxy blocks nber.org, arxiv.org, academic.oup.com). Used existing vault source Li et al. 2022 (§2) which covers the Rosenbaum-Rubin framework as part of its frequentist estimation review. Created 3 notes in `Econometrics/Identification Strategies/`: [[Propensity Score Matching]] (balancing score theorem, ATT estimand, treatment model guidance), [[Matching Algorithms and Caliper Matching]] (NN matching, caliper 0.2-SD rule, k:1, full matching, MatchIt R code), [[Covariate Balance Diagnostics]] (SMD formula, love plot, variance ratio, KS, overlap plots, cobalt R). Updated `Econometrics/Identification Strategies/_Index.md` (concept_count 16→19, 3 new routing entries, 3 new concept-map rows, 3 new notes in Notes section). Updated `Frequentist Causal Estimation.md` (added 3 new used_by links). Updated `Bayesian Propensity Score Weighting.md` (added depends_on link to PSM). Gap #1 marked 🍂 covered. |
