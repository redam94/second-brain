...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[Constraint-Based Structure Learning]], [[PC Algorithm]], [[Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-09-17)
...
| Causal Structure Learning: PC / GES (#9) | [[Markov Equivalence and CPDAGs]], [[Constraint-Based Structure Learning]], [[PC Algorithm]], [[Greedy Equivalence Search]] | 2026-09-17 |
...
| 2026-09-17 | Gap #9 (Causal Structure Learning: PC algorithm and GES) marked 🍂 covered. PDF downloads for Spirtes et al. (2000), Chickering (2002), and Meek (1995) attempted but blocked by session network proxy policy (403 Forbidden for arXiv, JMLR, and academic servers). Notes synthesized from: (1) NOTEARS paper (already in `Causal Discovery/raw/`) which cites and benchmarks PC and GES extensively; (2) GitHub documentation for `ges` (Gamella) and `causal-learn` (CMU); (3) WebSearch summaries of algorithm steps and properties. Created 4 new notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl equivalence theorem, v-structures, CPDAG definition, Meek's 4 rules), [[Constraint-Based Structure Learning]] (global Markov property, faithfulness, causal sufficiency, CI test types by data distribution), [[PC Algorithm]] (3-phase algorithm: skeleton discovery, v-structure orientation, Meek completion; consistency theorems; software table), [[Greedy Equivalence Search]] (FES + BES + turning phase; Meek conjecture; GES consistency; FGS super-consistency; BIC/BDeu scoring; Python/R code examples). Updated `Causal Discovery/_Index.md` (5 → 9 notes) and `DAG Structure Learning Problem.md` (`used_by` extended). |
