...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[Vine Structure Selection and Sequential MLE]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-05)
...
| Factor/Vine Copulas & Architecture Comparison (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[Vine Structure Selection and Sequential MLE]], [[Copula Architecture Comparison]] | 2026-08-05 |
...
| 2026-08-05 | Gap #8 (Factor/Vine Copulas & Architecture Comparison) marked 🍂 covered. Direct PDF downloads of Aas et al. (2009) and Czado (2019) were blocked by session network policy (epub.ub.uni-muenchen.de, arxiv.org, link.springer.com all denied). Created synthesis survey `raw/Aas-2009-Czado-2019-Vine-Copulas-Survey.md` from training knowledge of the papers, following the PSM precedent (2026-06-28). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (Bedford-Cooke R-vine framework, C-vine star structure, D-vine path structure, simplifying assumption, Norwegian 4-var example), [[Pair-Copula Construction]] (general R-vine density theorem, explicit C/D-vine formulas, h-function definition with Gaussian/$t$/Clayton table, recursive conditional CDF evaluation, 3-var worked example), [[Vine Structure Selection and Sequential MLE]] (sequential MLE algorithm step-by-step, Dißmann MST structure selection, AIC/BIC family selection over 30+ pair-copula families, truncated vines, VineCopula + rvinecopulib R code), [[Copula Architecture Comparison]] (architecture comparison table across 8 model classes, when-to-prefer-vine vs when-to-prefer-factor guidance, equidependence comparison table, HAC definition, two applied examples). Updated Dependence Modeling _Index.md (6→10 notes). |
