...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]], [[Causal Structure Learning - Overview]] (all in `Research/Causal Discovery/`, created 2026-08-13). Raw source downloaded: `raw/chickering-meek-sges.pdf` (Chickering & Meek, SGES paper). Primary sources (Chickering 2002 JMLR, Spirtes et al. 2000) were blocked by session network policy; content sourced from the SGES paper background and training knowledge.
...
| Causal Structure Learning (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]], [[Causal Structure Learning - Overview]] | 2026-08-13 |
...
| 2026-08-13 | Run 19 (Dream Ingest): Covered gap #9 (Causal Structure Learning from Data). Downloaded `Research/Causal Discovery/raw/chickering-meek-sges.pdf` (Chickering & Meek, SGES paper, 16pp). Primary sources (Chickering 2002 JMLR, Spirtes et al. 2000) blocked by session network policy. Created 4 notes in `Research/Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG uniqueness, covered edges, d-separation), [[PC Algorithm]] (3-phase pseudocode, faithfulness, causal sufficiency, Meek rules R1–R4, PC-stable order-independence fix, Kalisch-Bühlmann high-dim consistency), [[Greedy Equivalence Search (GES)]] (INSERT/DELETE operators with verbatim scoring formulas from SGES §3.1, Theorem 1 consistency, FES/BES pseudocode, BIC score requirements), [[Causal Structure Learning - Overview]] (paradigm comparison table PC vs GES vs NOTEARS, identifiability ceiling, when-to-use guide). Updated `Research/Causal Discovery/_Index.md` (5→9 notes), added `used_by` links to `DAG Structure Learning Problem.md`. Gap #9 marked 🍂 covered. |
