...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[Constraint-Based Causal Discovery]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Causal Discovery Methods Comparison]] (all in `Causal Discovery/`, created 2026-09-03). Note: PDFs of Spirtes et al. (2000) and Chickering (2002) were not downloaded due to network egress policy blocking jmlr.org and arxiv.org; reference stubs created in `raw/` with free-access URLs.
...
| Causal Structure Learning — PC / GES (#9) | [[Markov Equivalence and CPDAGs]], [[Constraint-Based Causal Discovery]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Causal Discovery Methods Comparison]] | 2026-09-03 |
...
| 2026-09-03 | Gap #9 (Causal Structure Learning — PC/GES constraint-based and score-based methods) marked 🍂 covered. Searched for Spirtes et al. (2000), Chickering (2002), and Kalisch & Bühlmann (2007) PDFs — all freely available at jmlr.org and cs.cmu.edu but blocked by network egress policy; created reference stubs in `Causal Discovery/raw/`. Created 5 notes: [[Markov Equivalence and CPDAGs]] (Verma & Pearl 1990 characterization theorem, CPDAG definition, compelled vs reversible edges, identifiability limits), [[Constraint-Based Causal Discovery]] (Causal Markov Condition, Faithfulness, Causal Sufficiency, CI test taxonomy, three-phase structure, SGS vs PC complexity), [[PC Algorithm]] (full pseudocode with Meek R1–R3 rules, $O(d^{k+2})$ complexity theorem, Kalisch & Bühlmann 2007 high-dim consistency, PC-stable definition, software table), [[Greedy Equivalence Search]] (BIC score definition, Insert/Delete CPDAG operators with score-change formulas, two-phase algorithm pseudocode, Chickering 2002 Meek conjecture proof, FGES note), [[Causal Discovery Methods Comparison]] (9-property comparison table, per-paradigm decision notes, empirical comparison from [[NOTEARS Experiments]], practitioner decision flowchart, ABM context). Updated [[Causal Discovery/_Index]] (5→10 notes). Updated `used_by` in [[DAG Structure Learning Problem]] and [[NOTEARS Experiments]]. |
