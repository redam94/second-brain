...
**Covered by (2026-09-12):** [[Vine Copulas - Overview]], [[Pair Copula Constructions]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-12). Sources: Aas et al. (2009), Bedford & Cooke (2001/2002), Czado (2019). PDFs inaccessible via egress proxy; citation metadata at `raw/Vine-Copulas-Aas-Czado-Survey.md`.
...
| Factor/Vine Copulas and Copula Architecture (#8) | [[Vine Copulas - Overview]], [[Pair Copula Constructions]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] | 2026-09-12 |
...
| 2026-09-12 | Gap #8 (Factor/Vine Copulas and Copula Architecture) marked 🍂 covered. Reviewed vine copula literature: Aas, Czado, Frigessi & Bakken (2009), Bedford & Cooke (2001/2002), Czado (2019), Brechmann & Schepsmeier (2013). PDF downloads blocked by session egress proxy (all academic domains: Insurance:ME journal, mediatum.ub.tum.de, nr.no). Created citation metadata file `raw/Vine-Copulas-Aas-Czado-Survey.md` from training-data knowledge of the papers (following the PSM survey precedent). Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC factorisation theorem, simplifying assumption, Bedford-Cooke framework, 4-variable D-vine example density), [[Pair Copula Constructions]] (h-function definition and formulas for Gaussian/t/Clayton/Gumbel, 4-variable D-vine and C-vine densities with explicit h-function tree, conditional density theorem, simulation algorithm), [[C-Vine and D-Vine Structures]] (D-vine path structure, C-vine star/root structure, R-vine proximity condition, 5-variable examples, truncated vine, structure selection heuristics), [[Vine Copula Estimation]] (marginal estimation strategies, sequential tree-by-tree MLE algorithm, consistency/asymptotic normality theorem, Dißmann 2013 greedy MST structure selection, pair copula family selection, 3-variable concrete example), [[Copula Architecture Comparison]] (full 10-architecture comparison table, elliptical/Archimedean/vine/factor strengths and weaknesses, Oh & Patton 2012 head-to-head empirical comparison for n=100, decision guide table). Updated `Dependence Modeling/_Index.md`: concept_count 6→11, added vine copula routing section, 5 new concept map rows, 5 new note entries with CONTAINS annotations, new source entry. |
