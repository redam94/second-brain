...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Constraint-Based Structure Learning]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-02)
...
| Causal Structure Learning (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Constraint-Based Structure Learning]], [[GES - Greedy Equivalence Search]] | 2026-08-02 |
...
| 2026-08-02 | Run 17: Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Searched for Spirtes, Glymour & Scheines (2000) and Chickering (2002) — both freely available (MIT Press / JMLR) but blocked by session network policy. Created synthesis survey `raw/PC-GES-Survey.md` from training knowledge. Created 3 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Markov equivalence definition, skeleton+v-structure characterization theorem, CPDAG definition, compelled/reversible edges, Meek rules R1–R4, identifiability wall), [[PC Algorithm - Constraint-Based Structure Learning]] (Phase 1 skeleton adjacency search, Phase 2 v-structure orientation, Phase 3 Meek rules, Fisher's z CI test, PC consistency theorem, Kalisch-Bühlmann high-dim consistency, order-dependence + PC-stable fix, FCI extension, chain + v-structure examples), [[GES - Greedy Equivalence Search]] (decomposable scores BIC/BDe/BGe, CPDAG lattice theorem, FES Insert operator, BES Delete operator, Chickering 2002 consistency theorem, Meek conjecture, FGES + GIES extensions). Updated Causal Discovery `_Index.md` (5→8 notes). |
