...
**Covered by:** [[Vine Copulas - Overview]], [[Vine Copula Construction and Density Factorization]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-07)
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Vine Copula Construction and Density Factorization]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] | 2026-08-07 |
...
| 2026-08-07 | Gap #8 (Factor Copulas & Vine Copulas) marked 🍂 covered. Direct PDF downloads blocked by session network policy (arxiv.org, ssrn.com, mediatum.ub.tum.de, all academic repositories blocked). Created synthesis raw source `raw/vine-copulas-compiled-sources.md` from accessible GitHub content (ArbitrageLab, VineCopulaMatlab READMEs) plus canonical citations (Aas et al. 2009, Bedford & Cooke 2002, Czado & Nagler 2022). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (Bedford-Cooke tree structure, C/D/R-vine types, 3-var example, comparison with factor copulas), [[Vine Copula Construction and Density Factorization]] (h-function with closed forms for Gaussian/$t$/Clayton/Gumbel; general Bedford-Cooke factorization theorem; C-vine and D-vine density formulas; simplifying assumption and its failure; recursive h-function computation; 4D D-vine example), [[Vine Copula Estimation and Model Selection]] (pseudo-observations; sequential MLE; joint MLE; Dissmann 2013 max-spanning-tree structure selection; AIC family selection; truncation; VineCopula / pyvinecopulib software; 5D workflow example), [[Copula Architecture Comparison]] (taxonomy table of all 4 architectures by parameters/tail/asymmetry/exchangeability/$n$; detailed factor vs vine trade-offs; decision framework). Updated `Econometrics/Dependence Modeling/_Index.md` (6→10 notes). |
