...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[PC Skeleton Discovery and CI Testing]], [[CPDAG Orientation - V-Structures and Meek Rules]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-10)
...
| Causal Structure Learning — PC & GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm - Overview]], [[PC Skeleton Discovery and CI Testing]], [[CPDAG Orientation - V-Structures and Meek Rules]], [[GES - Greedy Equivalence Search]] | 2026-08-10 |
...
| 2026-08-10 | Gap #9 (Causal Structure Learning — PC & GES) marked 🍂 covered. Primary source PDFs (Chickering 2002 JMLR, Spirtes et al. 2000 MIT Press, arXiv survey papers) are freely available but all academic domains (jmlr.org, arxiv.org, semanticscholar.org) were blocked by the session network policy. Downloaded GitHub reference materials: `ges-python-implementation-readme.md` (juangamella/ges, documents Chickering 2002 + Hauser & Bühlmann 2012), `causal-learn-pc-source.py` + `causal-learn-ges-source.py` (py-why/causal-learn). Created 5 new notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (prerequisite: Verma & Pearl 1990 characterisation theorem, CPDAG def, Meek completeness, identifiability limit), [[PC Algorithm - Overview]] (3 phases, consistency theorem, Stable PC, comparison table), [[PC Skeleton Discovery and CI Testing]] (skeleton discovery formal algorithm, adjacency-set sufficiency theorem, Fisher's Z / G-squared / KCI CI tests, Stable PC skeleton def, complexity analysis), [[CPDAG Orientation - V-Structures and Meek Rules]] (v-structure orientation rule, Meek R1–R4 definitions and completeness theorem, PDAG completion, Turning Phase note), [[GES - Greedy Equivalence Search]] (decomposable score def, BIC score def, Insert/FES/Delete/BES/Turn operators, GES consistency theorem proving the Meek Conjecture, PC vs GES comparison). Updated `Causal Discovery/_Index.md` (5→10 concept notes, new routing entries, expanded concept map, updated sources section, cross-cutting concepts). |
