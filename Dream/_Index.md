...
**Covered by (2026-09-05):** [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Causal Discovery]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Constraint-Based vs Score-Based Causal Discovery]] (all added to `Causal Discovery/`, 5 new notes covering PC + GES + shared foundations).
...
| Causal Structure Learning: PC + GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Causal Discovery]], [[PC Algorithm]], [[Greedy Equivalence Search]], [[Constraint-Based vs Score-Based Causal Discovery]] | 2026-09-05 |
...
| 2026-09-05 | Gap #9 (Causal Structure Learning: PC + GES) marked 🍂 covered. Searched for Chickering (2002) JMLR and Kalisch & Bühlmann (2007) JMLR/arXiv PDFs — both open-access but blocked by network egress policy (jmlr.org and arxiv.org denied). Created source stubs `raw/chickering2002-GES.txt` and `raw/kalisch2007-PC.txt`. Created 5 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Verma-Pearl theorem, skeleton/v-structure defs, CPDAG def, Meek rules R1–R4), [[Conditional Independence Tests for Causal Discovery]] (CI def, partial correlation, Fisher z-test full theorem, G-test, KCI overview, test-selection table), [[PC Algorithm]] (Markov+faithfulness assumptions, PC-Skeleton pseudocode, v-structure orientation rule, correctness theorem, Kalisch-Bühlmann high-dimensional consistency theorem, 4-variable worked example, limitations table, PC-stable note), [[Greedy Equivalence Search]] (decomposable score def, BIC score def, FES+BES pseudocode, Insert/Delete operators, Meek Conjecture / Chickering Thm 15+17, turning phase, 2 worked examples), [[Constraint-Based vs Score-Based Causal Discovery]] (algorithm taxonomy table, PC/GES/NOTEARS strengths+weaknesses, decision guide table, shared identifiability ceiling, evaluation metrics). Updated `Causal Discovery/_Index.md` (5→10 notes, routing summary, concept map, notes list, sources). |
