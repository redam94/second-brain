...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Conditional Independence Tests for Structure Learning]], [[GES Algorithm]] (all in `Causal Discovery/`, created 2026-09-22)
...
| Causal Structure Learning — PC/GES (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Conditional Independence Tests for Structure Learning]], [[GES Algorithm]] | 2026-09-22 |
...
| 2026-09-22 | Gap #9 (Causal Structure Learning — PC/GES) marked 🍂 covered. Searched for Chickering (2002) JMLR and Kalisch & Bühlmann (2007) arXiv — both exist as free PDFs but blocked by session network egress policy. Source metadata stubs created in `Causal Discovery/raw/`. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl equivalence theorem, v-structures, CPDAG definition, Meek rules R1–R4 with block IDs), [[PC Algorithm]] (skeleton learning pseudocode with adjacency-set restriction, v-structure orientation, consistency theorem, PC-stable variant, 4-variable example), [[Conditional Independence Tests for Structure Learning]] (Fisher's Z full formula, G²/χ² for discrete, KCI, comparison table, α selection for high-dimensional settings, software links), [[GES Algorithm]] (decomposable/locally consistent score definition, Insert/Delete operators with clique conditions, GES two-phase pseudocode, Meek Conjecture/consistency theorem, FGES extension, PC vs GES comparison table). Updated `Causal Discovery/_Index.md` (5→9 notes). |
