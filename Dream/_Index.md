...
**Covered by:** [[PC Algorithm - Constraint-Based Causal Discovery]], [[GES - Greedy Equivalence Search]], [[Causal Structure Learning - Methods Comparison]] (all in `Causal Discovery/`, created 2026-08-19)
...
| Causal Structure Learning — PC & GES (#9) | [[PC Algorithm - Constraint-Based Causal Discovery]], [[GES - Greedy Equivalence Search]], [[Causal Structure Learning - Methods Comparison]] | 2026-08-19 |
...
| 2026-08-19 | Gap #9 (Causal Structure Learning — PC & GES) marked 🍂 covered. Attempted PDF downloads for Spirtes, Glymour & Scheines (2000) and Chickering (2002, JMLR) — both are freely available but blocked by session network proxy. Notes written from primary-source knowledge. Created 3 notes in `Causal Discovery/`: [[PC Algorithm - Constraint-Based Causal Discovery]] (Markov/Faithfulness/Sufficiency assumptions, 3-phase skeleton→v-structures→Meek, Fisher's Z CI test, CPDAG definition, high-dimensional consistency, PC-stable variant); [[GES - Greedy Equivalence Search]] (decomposable BIC/BDeu score, FES+BES two-phase algorithm, Insert/Delete operators, Meek Conjecture / Chickering Theorem 15, consistency guarantee, FGES scaling, 3-node worked example); [[Causal Structure Learning - Methods Comparison]] (three-way PC vs GES vs NOTEARS table, observational equivalence fundamental limit, identifiability table, decision guide, software ecosystem). Updated `Causal Discovery/_Index.md` (5→8 notes, new routing summary, updated concept map and sources). |
