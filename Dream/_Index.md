...
**Covered by:** [[Vine Copulas - Overview]], [[C-vine and D-vine Structures]], [[Vine Copula Density and Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-20)
...
| Factor & Vine Copulas / Architecture (#8) | [[Vine Copulas - Overview]], [[C-vine and D-vine Structures]], [[Vine Copula Density and Estimation]], [[Copula Architecture Comparison]] | 2026-07-20 |
...
| 2026-07-20 | Gap #8 (Factor & Vine Copulas / Architecture) marked 🍂 covered. Network policy blocked PDF downloads from all external academic hosts (epub.ub.uni-muenchen.de, projecteuclid.org, arxiv.org). Created synthesis survey `raw/Vine-Copulas-Survey.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2002), Joe (1996), Dissmann et al. (2013), Czado (2019), Czado & Nagler (2022). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (pair-copula construction idea, R-vine definition, simplifying assumption, C/D-vine as special cases), [[C-vine and D-vine Structures]] (star vs path tree structures, density formulas, $h$-function recursion, sampling algorithms, worked $d=4$ examples), [[Vine Copula Density and Estimation]] (vine log-likelihood, sequential MLE, full MLE, Dissmann structure selection, AIC/BIC family selection, truncated vines, R/Python code), [[Copula Architecture Comparison]] (comparison table across Gaussian/$t$/Archimedean/vine/factor; decision guide by dimensionality). Updated Dependence Modeling `_Index.md` (6→10 notes). |
