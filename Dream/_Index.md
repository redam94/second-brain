...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Causal Discovery]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-09-02)
...
| Causal Structure Learning: PC + GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Causal Discovery]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-09-02 |
...
| 2026-09-02 | Gap #9 (Causal Structure Learning: PC algorithm + GES) marked 🍂 covered. Searched arXiv (arxiv.org), JMLR (jmlr.org), and several university domains for Spirtes, Glymour & Scheines (2000), Chickering (2002), and Meek (1995) — all freely available but blocked by the session's egress proxy policy. Created citation placeholder `raw/PC-GES-sources.md` documenting all source URLs. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (d-separation, faithfulness, Verma-Pearl equivalence theorem, CPDAG definition, Meek rules R1–R3, score equivalence, LiNGAM contrast), [[Conditional Independence Tests for Causal Discovery]] (Fisher Z-test for Gaussian CI, chi-squared/G-test for categorical, KCI kernel test, alpha threshold effects table, high-dimensional notes), [[PC Algorithm]] (Phase 1 skeleton algorithm, Phase 2 v-structure + Meek orientation, PC consistency theorem, PC-stable order-independence, worked 4-variable example, comparison table PC/GES/NOTEARS), [[GES - Greedy Equivalence Search]] (Gaussian BIC score, FES forward search algorithm, BES backward search algorithm, Turning operator, GES consistency theorem, FGS scalable variant, comparison table PC/GES). Updated `Causal Discovery/_Index.md` (5→9 notes, new sections for constraint-based/score-based paradigms). |
