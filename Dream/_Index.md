...
**Covered by:** [[Causal Structure Learning - Overview]], [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-23)
...
| Causal Structure Learning from Data (#9) | [[Causal Structure Learning - Overview]], [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]] | 2026-08-23 |
...
| 2026-08-23 | Gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Source PDFs (jmlr.org, arxiv.org) blocked by session network policy; created synthesis survey `raw/PC-GES-Constraint-Score-Based-Survey.md` from training knowledge of Spirtes, Glymour & Scheines (2000) and Chickering (2002). Created 4 notes in `Causal Discovery/`: [[Causal Structure Learning - Overview]] (paradigm comparison: constraint-based / score-based / continuous optimization; identification limit theorem; when-to-use guide), [[Markov Equivalence and CPDAGs]] (Markov condition, faithfulness, Verma-Pearl theorem, CPDAG definition, Meek's four rules R1–R4), [[PC Algorithm]] (full 3-phase algorithm: skeleton/V-structure/Meek propagation; consistency theorem SGS Thm 5.1; Gaussian CI test; PC-stable extension), [[Greedy Equivalence Search]] (FES + BES algorithms; Insert/Delete operators; Meek Conjecture proof Chickering Thm 1; GES consistency Thm 15; PC vs GES comparison table). Updated `Causal Discovery/_Index.md` (5→9 notes). |
