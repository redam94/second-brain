...
**Covered by:** [[Vine Copulas - Overview]], [[Vine Copula Structures - C-vine and D-vine]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-04)

**Previously partially addressed (2026-06-22):** The `Econometrics/Dependence Modeling/` subfolder has 6 factor-copula notes: [[Factor Copulas - Overview]], [[Factor Copula Construction]], [[Multi-Factor and Block Dependence Structures]], [[Tail Dependence in Factor Copulas]], [[SMM Estimation of Factor Copulas]], [[Factor Copula Application - S&P 100 and Systemic Risk]].
...
|-----|-----------|--------------|
| Factor Copulas & Vine/Pair Copulas (#8) | [[Vine Copulas - Overview]], [[Vine Copula Structures - C-vine and D-vine]], [[Vine Copula Estimation]], [[Copula Architecture Comparison]] | 2026-09-04 |
...
| 2026-09-04 | Dream ingest run: Gap #8 (Factor Copulas & Vine Copulas) marked 🍂 covered. Searched for Aas et al. (2009), Bedford & Cooke (2002), Nagler (2024) — free PDFs confirmed to exist at LMU Munich repository, INRIA, and arXiv respectively, but all blocked by session egress proxy policy (connect_rejected). Notes written from training knowledge and WebSearch-verified formulas. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC framework, R-vine definition, simplifying assumption, h-function recursion, trivariate worked example); [[Vine Copula Structures - C-vine and D-vine]] (D-vine path/density formula, C-vine star/density formula, $d=4$ worked examples, C/D/R-vine comparison table, truncated vines); [[Vine Copula Estimation]] (two-stage IFM, structure selection via max-spanning tree of $\|\hat\tau\|$, sequential vs full MLE, mBICV, GOF, VineCopula/rvinecopulib R code, pyvinecopulib Python code); [[Copula Architecture Comparison]] (decision table across all four architectures, when factor beats vine, Gaussian copula failure story, 10-asset portfolio example). Updated `Dependence Modeling/_Index.md` (6→10 notes). Updated `Factor Copulas - Overview.md` (used_by + vine wikilink). |
