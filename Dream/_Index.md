...
**Covered by:** [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-13)
...
| Factor/Vine Copulas & Architecture Comparison (#8) | [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Vine Copula Estimation and Selection]], [[Copula Architecture Comparison]] | 2026-07-13 |
...
| 2026-07-13 | Run 14: addressed gap #8 (Factor/Vine Copulas — 🌿 still relevant → 🍂 covered). Vine/pair copula side was absent. Searched for free PDFs (Aas et al. 2009, Bedford & Cooke 2002, Czado 2010) — all blocked by session network policy. Created synthesis survey `raw/Aas-Czado-2009-Vine-Copula-Survey.md` from training knowledge of Aas et al. (2009) Insurance: Mathematics and Economics 44:182-198 (pair-copula constructions), Bedford & Cooke (2002) Annals of Statistics 30:1031-1068 (vine graphical model), and Dissmann et al. (2013) CSDA 59:52-69 (structure selection). Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (Bedford-Cooke vine density factorization theorem, simplifying assumption, position in literature), [[C-Vine and D-Vine Structures]] (star vs path tree structures, explicit $n$-variable density formulas, h-function definition and closed forms, conditional CDF recursion algorithm), [[Vine Copula Estimation and Selection]] (sequential MLE algorithm, joint MLE, Dissmann max-spanning-tree structure selection, family menu + AIC/BIC selection, truncation, rvinecopulib R code), [[Copula Architecture Comparison]] (9-dimension comparison table, when-to-use guidelines, tail-dependence comparison, S&P 100 and 5-stock examples). Updated `Dependence Modeling/_Index.md` (6→10 notes) and `Econometrics/_Index.md` (51→55 notes). |
