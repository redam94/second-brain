...
**Covered by:** [[PC Algorithm]], [[GES Algorithm]], [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Structure Learning]], [[Causal Structure Learning - Paradigm Overview]] (all in `Causal Discovery/`, created 2026-09-15)
...
| Causal Structure Learning — PC + GES (#9) | [[Causal Structure Learning - Paradigm Overview]], [[Markov Equivalence Classes and CPDAGs]], [[Conditional Independence Tests for Structure Learning]], [[PC Algorithm]], [[GES Algorithm]] | 2026-09-15 |
...
| 2026-09-15 | Gap #9 (Causal Structure Learning — PC + GES) marked 🍂 covered. Searched for Chickering (2002) JMLR and Spirtes, Glymour & Scheines (2000) — both freely available but blocked by session network policy (jmlr.org, arxiv.org return 403 from proxy). Created 5 notes in `Causal Discovery/` from training knowledge of canonical papers: [[Causal Structure Learning - Paradigm Overview]] (paradigm comparison table, when-to-use guide), [[Markov Equivalence Classes and CPDAGs]] (Verma-Pearl theorem, Meek's four rules, CPDAG definition), [[Conditional Independence Tests for Structure Learning]] (Fisher z-test, chi-square, KCI, faithfulness + Markov condition), [[PC Algorithm]] (full three-phase algorithm, consistency theorem, PC-stable variant, worked example, software), [[GES Algorithm]] (decomposable score, BIC, Meek Conjecture, forward+backward phases, consistency theorem, worked example, software). Updated `Causal Discovery/_Index.md` (5→10 notes). |
