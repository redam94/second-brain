...
**Covered by:** [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-09-25)
...
| Factor Copulas & Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair-Copula Construction]], [[Copula Architecture Comparison]] | 2026-09-25 |
...
| 2026-09-25 | Gap #8 (Factor Copulas & Vine Copulas / High-Dimensional Copula Architectures) marked 🍂 covered. Searched epub.ub.uni-muenchen.de (LMU preprint of Aas et al. 2009), mediaTUM TUM repository (Czado 2010 tutorial), arXiv (Dißmann et al. 2013, 1202.2002), SSRN — all blocked by session egress proxy policy. Created synthesis survey `raw/Vine-Copulas-Aas2009-Survey.md` from training knowledge of the foundational papers (Aas et al. 2009; Bedford & Cooke 2001, 2002; Dißmann et al. 2013; Czado & Nagler 2022). Created 3 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (Bedford & Cooke factorisation theorem, C-vine/D-vine/R-vine definitions with $d=4$ examples, proximity condition), [[Pair-Copula Construction]] (h-function definition & closed-form table for Gaussian/t/Clayton/Gumbel/Independence; h-function recursion; vine log-likelihood; sequential IFM estimator; AIC-based pair-copula family selection), [[Copula Architecture Comparison]] (taxonomy table across all copula architectures; factor vs. vine strengths/limitations; decision guide by dimensionality and use case). Updated Dependence Modeling _Index.md (6→9 notes). |
