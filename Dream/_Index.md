...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Construction and Regular Vines]], [[C-vines and D-vines]], [[Vine Copula Estimation and Model Selection]] (all in `Econometrics/Dependence Modeling/`, created 2026-08-01)
...
| Factor/Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction and Regular Vines]], [[C-vines and D-vines]], [[Vine Copula Estimation and Model Selection]] | 2026-08-01 |
...
| 2026-08-01 | Gap #8 (Factor/Vine Copulas) marked 🍂 covered. Sources identified: Aas et al. (2009) [LMU Munich preprint], Bedford & Cooke (2002) [Project Euclid], Czado & Nagler (2022) [SSRN preprint], Dissmann et al. (2013) [TUM preprint]. Direct PDF download blocked by session network proxy policy for all academic hosts; notes written from established mathematical content of these papers and recorded in `raw/SOURCES-vine-copulas.md`. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (copula architecture comparison table, factor vs vine tradeoffs, scaling analysis), [[Pair Copula Construction and Regular Vines]] (Bedford-Cooke regular vine definition, proximity condition, PCC density factorization theorem, simplifying assumption, 3-var worked example), [[C-vines and D-vines]] (star vs path tree structures, C-vine and D-vine density formulas, h-function and its closed forms for Gaussian/t/Clayton/Gumbel, inverse h-function for simulation), [[Vine Copula Estimation and Model Selection]] (IFM marginal pre-processing, Dissmann MST algorithm, sequential MLE, full MLE, Rosenblatt PIT diagnostics, VineCopula R code, 4-var worked example). Updated Dependence Modeling `_Index.md` (6→10 notes). |
