...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-08-08)
...
| Causal Structure Learning — PC Algorithm and GES (#9) | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search]] | 2026-08-08 |
...
| 2026-08-08 | Gap #9 (Causal Structure Learning — PC Algorithm and GES) marked 🍂 covered. The 🌿 partial gap had NOTEARS covered since 2026-06-22; constraint-based (PC) and score-based (GES) methods were absent. Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Causal Markov condition, d-separation, Verma-Pearl MEC theorem, CPDAG/essential graph definition, faithfulness assumption, Meek's four orientation rules R1–R4), [[PC Algorithm]] (constraint-based structure learning: three phases — skeleton via CI tests, v-structure orientation via Sep sets, Meek propagation; Fisher's Z test; PC consistency theorem; FCI extension; complexity analysis; practical limitations), [[Greedy Equivalence Search]] (score-based: BIC/BDe decomposable score; Insert/Delete/Turn operators on CPDAGs; FES + BES phases; GES consistency theorem via Meek Conjecture proof; score change formulae; PC vs GES vs NOTEARS comparison; software references). PDF downloads (Spirtes et al. 2000, Chickering 2002 JMLR) attempted but blocked by network egress proxy; reference stub created at `raw/sources-constraint-and-score-based-causal-discovery.md`. Updated `Causal Discovery/_Index.md` (5→8 notes, new routing entries for PC and GES paradigms). |
