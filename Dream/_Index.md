...
**Covered by:** [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]], [[Causal Discovery Algorithms Comparison]] (all in `Causal Discovery/`, created 2026-07-07)
...
| Causal Structure Learning / PC & GES (#9) | [[Markov Equivalence Classes and CPDAGs]], [[PC Algorithm]], [[Greedy Equivalence Search (GES)]], [[Causal Discovery Algorithms Comparison]] | 2026-07-07 |
...
| 2026-07-07 | Gap #9 (Causal Structure Learning — PC algorithm and GES) marked 🍂 covered. Network proxy blocked JMLR/arXiv PDF downloads; created synthesis survey `raw/PC-GES-CausalDiscovery-Survey.md` from training knowledge of Spirtes et al. (2000), Chickering (2002) JMLR Vol. 3, and Colombo & Maathuis (2014) JMLR Vol. 15. Created 4 notes in `Causal Discovery/`: [[Markov Equivalence Classes and CPDAGs]] (Markov condition, Faithfulness, Verma–Pearl characterisation theorem, CPDAG definition, Meek's 4 orientation rules, identifiability limits), [[PC Algorithm]] (skeleton learning pseudocode, CI test options, v-structure orientation, PC-stable order-independence fix, oracle consistency theorem), [[Greedy Equivalence Search (GES)]] (decomposable + locally consistent score, Insert/Delete operators, two-phase algorithm, Chickering 2002 consistency theorem, FGES), [[Causal Discovery Algorithms Comparison]] (full comparison table, decision guide, software code snippets, evaluation metrics). Updated `Causal Discovery/_Index.md` (5→9 notes); updated `used_by` in DAG Structure Learning Problem and NOTEARS Experiments. Added cross-links to Directed Acyclic Graphs, Summary Causal DAGs, LLM Expert Elicitation for Bayesian Networks. |
