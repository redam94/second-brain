...
**Partially addressed (2026-06-22):** The `Causal Discovery/` subfolder covered NOTEARS comprehensively.

**Covered by:** [[Markov Equivalence and CPDAGs]], [[Constraint-Based Causal Discovery]], [[PC Algorithm]], [[Conditional Independence Tests for Structure Learning]], [[Greedy Equivalence Search (GES)]] (all added to `Causal Discovery/`, 2026-07-12)
...
| Causal Structure Learning from Data (#9) | [[Markov Equivalence and CPDAGs]], [[Constraint-Based Causal Discovery]], [[PC Algorithm]], [[Conditional Independence Tests for Structure Learning]], [[Greedy Equivalence Search (GES)]] | 2026-07-12 |
...
| 2026-07-12 | Dream-ingest run 14: gap #9 (Causal Structure Learning from Data) marked 🍂 covered. Constraint-based methods (PC algorithm, conditional independence testing) and GES (score-based Greedy Equivalence Search) — the two remaining sub-gaps — now covered. Downloaded sources blocked by session network policy; created synthesis surveys `raw/spirtes-glymour-scheines-2000-PC-algorithm.md` (Spirtes et al. 2000 CPS book + Meek 1995 + Spirtes & Glymour 1991) and `raw/chickering-2002-GES-JMLR.md` (Chickering 2002 JMLR, open-access). Created 5 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl theorem, CPDAG, covered edge reversals, Meek R1–R4), [[Constraint-Based Causal Discovery]] (CI=d-separation duality, three-phase framework, skeleton theorem, faithfulness, FCI extension), [[PC Algorithm]] (full pseudocode, oracle correctness, PC-stable, complexity $O(d^{k+2})$), [[Conditional Independence Tests for Structure Learning]] (Fisher-Z, $G^2$, KCIT/HSIC, comparison table), [[Greedy Equivalence Search (GES)]] (BIC/BGe scores, Insert/Delete operators, Chickering Thm 15, FGES speedup, R `pcalg::ges()` code). Updated `Causal Discovery/_Index.md` (5→10 notes). |
