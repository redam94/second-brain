...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Construction and h-Functions]], [[C-Vine and D-Vine Structures]], [[Regular Vine Copulae and Structure Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-10)
...
| Factor Copulas and Vine Copula Architectures (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction and h-Functions]], [[C-Vine and D-Vine Structures]], [[Regular Vine Copulae and Structure Selection]], [[Copula Architecture Comparison]] | 2026-07-10 |
...
| 2026-07-10 | Run 14: Gap #8 (Factor Copulas and High-Dimensional Copula Architectures) marked 🍂 covered. Vine/pair copula sources (Aas et al. 2009 *IME*; Dissmann et al. 2013 *CSDA* / arXiv:1202.2002; Czado & Nagler 2022 *AnnRevStat*; Bedford & Cooke 2002 *AnnStat*) are freely available but blocked by session egress policy. Created synthesis survey `Econometrics/Dependence Modeling/raw/Vine-Copula-Synthesis-Survey.md`. Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC idea, simplifying assumption, vine types, comparison table), [[Pair Copula Construction and h-Functions]] (h-function definition + closed forms for Normal/t/Clayton, recursive pseudo-obs, sequential MLE, pair copula family table), [[C-Vine and D-Vine Structures]] (star vs path topology, explicit density formulas for d=4, when to use each), [[Regular Vine Copulae and Structure Selection]] (proximity condition, vine matrix, Dissmann greedy MST algorithm, truncated vines, 5-variable financial application), [[Copula Architecture Comparison]] (Gaussian/t/Archimedean/vine/factor matrix, tail-dep table, scalability analysis, decision guide by dimension). Updated `Dependence Modeling/_Index.md` (6→11 notes), `Econometrics/_Index.md` (51→56 notes). |
