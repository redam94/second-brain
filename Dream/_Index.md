...
**Covered by:** [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Regular Vine Copulas and R-Vine Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-15)
...
| Factor/Vine Copulas and Copula Architecture (#8) | [[Vine Copulas - Overview]], [[C-Vine and D-Vine Structures]], [[Regular Vine Copulas and R-Vine Selection]], [[Copula Architecture Comparison]] | 2026-07-15 |
...
| 2026-07-15 | Run 15: Covered gap #8 (Factor/Vine Copulas and High-Dimensional Copula Architectures — vine/pair copula part). PDF downloads for Aas et al. (2009), Bedford & Cooke (2001/2002), Dissmann et al. (2013), Czado & Nagler (2022) were unavailable due to session network policy blocking arXiv, SSRN, JMLR, NBER, and academic institutional repositories. Created synthesis survey `raw/Vine-Copulas-Survey-Aas-Czado-Bedford-Cooke.md` from comprehensive training-knowledge coverage of the four principal references. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (PCC density decomposition, h-function, simplifying assumption, trivariate example), [[C-Vine and D-Vine Structures]] (star vs path topology, 4-variable density formulas, h-function recursion for both, when to prefer each, R code), [[Regular Vine Copulas and R-Vine Selection]] (R-vine definition with proximity condition, Dissmann et al. greedy max-spanning-tree algorithm, AIC family selection, vine truncation, rvinecopulib/pyvinecopulib code), [[Copula Architecture Comparison]] (vine vs factor copula: parameter count $O(d^2)$ vs $O(Kd)$, closed form vs SMM, per-pair vs analytical EVT tail dependence, dimension scaling table). Updated Dependence Modeling _Index.md (6→10 notes) and Econometrics _Index.md (51→55 notes). Gap #8 marked 🍂 covered. |
