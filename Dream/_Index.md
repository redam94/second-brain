...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Sequential Estimation for Vine Copulas]] (all in `Econometrics/Dependence Modeling/`, added 2026-08-27). Factor copula notes (6 notes, 2026-06-22) already present.
...
| Factor/Vine Copulas and Architecture Comparison (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-Vine and D-Vine Structures]], [[Sequential Estimation for Vine Copulas]] | 2026-08-27 |
...
| 2026-08-27 | Gap #8 (Factor Copulas and High-Dimensional Copula Architectures) marked 🍂 covered. The remaining vine/pair copula sub-gap was addressed. Searched arXiv, LMU Munich epub repository, and TU Munich mediatum for Aas et al. (2009) and Czado survey — all freely available but blocked by session network proxy. Fetched technical content from pyvinecopulib and arbitragelab GitHub pages. Created synthesis survey `raw/Aas-et-al-2009-Vine-Copula-Survey.md` capturing Bedford & Cooke (2002) and Aas et al. (2009) content from training knowledge and GitHub documentation. Created 4 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (motivation, advantages/limitations, architecture comparison table vs factor copulas), [[Pair Copula Construction]] (Bedford-Cooke R-vine density factorization theorem, proximity condition, simplifying assumption, h-function definition), [[C-Vine and D-Vine Structures]] (star/path topologies, density formulas, 4-variable worked examples, Dissmann structure selection, truncation), [[Sequential Estimation for Vine Copulas]] (h-function table for 5 copula families, sequential MLE algorithm, simulation via inverse h-function, family selection by AIC, software notes). Updated Dependence Modeling _Index.md (6→10 notes, added vine copula routing summary and concept map section). |
