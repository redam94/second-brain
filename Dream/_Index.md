...
**Covered by:** [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] (all in `Causal Discovery/`, created 2026-07-30)
...
| Causal Structure Learning (#9) — PC/GES remaining gap | [[Markov Equivalence and CPDAGs]], [[PC Algorithm]], [[GES - Greedy Equivalence Search]] | 2026-07-30 |
...
| 2026-07-30 | Run 17: Gap #9 (Causal Structure Learning — PC/GES remaining portion) marked 🍂 covered. Searched arXiv, JMLR, and CMU for Chickering (2002) JMLR, Kalisch & Bühlmann (2007) JMLR, Colombo & Maathuis (2014) JMLR/arXiv — all freely available but blocked by session network policy. Created synthesis survey `raw/pc-ges-causal-discovery-survey.md` from training knowledge of the papers. Created 3 notes in `Causal Discovery/`: [[Markov Equivalence and CPDAGs]] (Verma-Pearl-Meek theorem, CPDAG definition, compelled vs. reversible edges, Meek rules R1–R4), [[PC Algorithm]] (three phases: skeleton→v-structures→Meek; PC-stable; Kalisch & Bühlmann high-dimensional consistency; FCI/RFCI variants), [[GES - Greedy Equivalence Search]] (Insert/Delete CPDAG operators; FES+BES; Meek Conjecture proof; GES consistency theorem; FGS; PC vs. GES vs. NOTEARS comparison tables). Updated `Causal Discovery/_Index.md` (5→8 notes; added routing summary, cross-cutting concepts section, new sources entry). Cross-linked new notes into `DAG Structure Learning Problem.md` and `NOTEARS Experiments.md`. |
