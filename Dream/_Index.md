...
**Covered by:** [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-vine and D-vine Structures]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] (all in `Econometrics/Dependence Modeling/`, created 2026-07-09)
...
| Factor Copulas / Vine Copulas (#8) | [[Vine Copulas - Overview]], [[Pair Copula Construction]], [[C-vine and D-vine Structures]], [[Vine Copula Estimation and Model Selection]], [[Copula Architecture Comparison]] | 2026-07-09 |
...
| 2026-07-09 | Gap #8 (Factor Copulas / Vine Copulas) marked 🍂 covered. Network access to academic PDF hosts (inrialpes.fr, econstor.eu, arxiv.org) blocked by session policy; created synthesis survey `raw/Vine-Copulas-PCC-Survey.md` from training knowledge of Aas et al. (2009), Bedford & Cooke (2001, 2002), Czado (2019), Czado & Nagler (2022), Dissmann et al. (2013). Created 5 notes in `Econometrics/Dependence Modeling/`: [[Vine Copulas - Overview]] (history, motivation, PCC concept, high-level comparison), [[Pair Copula Construction]] (R-vine definition, density factorization, simplifying assumption, h-function recursion, pair families table, trivariate example), [[C-vine and D-vine Structures]] (formal definitions, complete $d=4$ tree structures for each with all pair copulas, comparison table, root/ordering selection heuristics), [[Vine Copula Estimation and Model Selection]] (pseudo-observations, Dissmann greedy spanning-tree algorithm, sequential MLE / IFM, full MLE, AIC/BIC pair family selection, truncated vines, R/Python software), [[Copula Architecture Comparison]] (Normal copula definition and criticism, $t$-copula limitations, Archimedean families, comprehensive 5-architecture × 8-property table, decision guide, Oh & Patton 2012 S&P 100 findings). Updated `Econometrics/Dependence Modeling/_Index.md` (6 → 11 notes). |
