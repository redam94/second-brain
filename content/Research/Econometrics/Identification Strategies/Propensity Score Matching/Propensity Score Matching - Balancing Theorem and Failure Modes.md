---
title: "Propensity Score Matching - Balancing Theorem and Failure Modes"
aliases:
  - PSM balancing theorem
  - why PSM fails
...
- [[Bayesian Inverse Probability Weighting]] — Bayesian extension using the Liao-Zigler marginalization (weighting, not matching)
...
- [[Propensity Score Matching - Overview]] — the Stuart (2010) cluster overview: four-step matching workflow and the four uses of the propensity score; this note adds the Rosenbaum–Rubin balancing theorem, the ATT estimand, PSM vs IPW, and the activity-bias failure case
