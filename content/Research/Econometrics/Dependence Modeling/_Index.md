...
> - Need vine / pair-copula constructions (C-vine, D-vine, R-vine, simplifying assumption, Dißmann)? -> [[Research/Econometrics/Dependence Modeling/Vine Copulas/_Index|Vine Copulas]]

## Sub-topics

| Sub-topic | Notes | Covers |
|-----------|-------|--------|
| [[Research/Econometrics/Dependence Modeling/Vine Copulas/_Index\|Vine Copulas]] | 5 | Pair-copula constructions, C-vines / D-vines / regular vines, the simplifying assumption, sequential estimation & Dißmann's structure-selection algorithm — Aas (2016) |
