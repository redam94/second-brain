...
> - Need the horseshoe / regularized horseshoe / global-local shrinkage family in depth? -> [[Research/Bayesian Statistics/Regression Models/Shrinkage Priors/_Index|Shrinkage Priors]]
...
|-----------|-------|--------|
| [[Research/Bayesian Statistics/Regression Models/Shrinkage Priors/_Index\|Shrinkage Priors]] | 5 | Global-local shrinkage, the horseshoe and regularized (Finnish) horseshoe, effective number of nonzeros, choosing the global scale — Piironen & Vehtari (2017) |
